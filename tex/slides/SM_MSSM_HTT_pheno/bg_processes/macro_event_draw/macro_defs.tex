...
\draw [ltcolorred] (#1+17:1) node {\ele};
}
\def\printmu#1{
\draw [thick, ltcolorblue] (0,0) arc (#1-90:#1-90+33:6) arc (#1-90+33:#1-90:-12) node{\mu};
\draw [ltcolorblue] (#1+5:2) node {\mu};
}

\def\printphoton#1{
\draw [thin, dashed, black] (0,0) --+ (#1:{.5*(\ECALrin+\ECALrout)});
\draw [black] (#1+7:{.75*\ECALrin+.25*\ECALrout}) node {\photon};
}
...
\draw [thin, dashed, ltcolorgreen4] (0,0) --+ (#2:{.5*(\ECALrin+\ECALrout)});
\draw [thin, dashed, ltcolorgreen4] (0,0) --+ (#2+7:{.5*(\ECALrin+\ECALrout)});
}{}
\ifthenelse{\equal{#1}{10}\or\equal{#1}{11}}{}{
\draw [thick, ltcolorgreen4] (0,0) arc (#2-90:#2-90+11:10) ;
\draw [thick, ltcolorgreen4] (0,0) arc (#2-90:#2-90-11:-10) ;
}
\draw [thick, ltcolorgreen4] (0,0) arc (#2-90:#2-90+6:20) ;
\draw [ltcolorgreen4] (#2-12:1.5) node {\tauh};
}
...
\def\printeledeposit#1{\printECALdeposit{ltcolorblue4}{#1+14}}
\def\printantieledeposit#1{\printECALdeposit{ltcolorblue4}{#1-14}}

\def\printphotondeposit#1{\printECALdeposit{ltcolorblue4}{#1}}
...
\ifthenelse{\equal{#1}{10}\or\equal{#1}{11}}{}{
\printHCALdeposit{ltcoloryellow4}{#2+5}
\printHCALdeposit{ltcoloryellow4}{#2-5}
}
\printHCALdeposit{ltcoloryellow4}{#2+3}
}
...
\draw [black] (#1+5:{.75*\HCALrin+.25*\HCALrout}) node {\neutrino};
}