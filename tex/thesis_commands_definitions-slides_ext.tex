...
\renewcommand{\fakefactor}{fake factor}
\renewcommand{\fakefactors}{fake factors}
\renewcommand{\Fakefactor}{Fake factor}
\renewcommand{\Fakefactors}{Fake factors}
...
\renewcommand{\Loss}{\ensuremath{\mathfrak{L}}}

\renewcommand{\NNeurons}{\ensuremath{N_\text{N}}}
\renewcommand{\NLayers}{\ensuremath{N_\text{L}}}
...
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=7.4575cm]{\PhDthesisdir/plots_and_images/my_plots/#1/limits/#2/mssm_mh125_#2#3.pdf}};
\end{scope}
