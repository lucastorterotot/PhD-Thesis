...
\draw (0,0) node [inner sep = 0pt, anchor = center] {\includegraphics[width=\paperwidth, height=\paperheight, keepaspectratio]{\homedir/Dropbox/PhD/00_autres/2021-06-23-defense_rehearsal_KIT/Cern_Cantina_cheatsheet.pdf}};
\end{tikzpicture}
\end{center}
\end{frame}
