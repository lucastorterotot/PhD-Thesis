...
\title[Search for additional heavy Higgs bosons decaying to tau lepton pair in the CMS experiment...]{\large Recherche de bosons de Higgs supplémentaires de haute masse se désintégrant en paire de taus dans l'expérience CMS au LHC à l'aide du \emph{machine learning}}
...
\def\upperrightlogos{\includegraphics[height=.5cm]{\PhDthesisdir/plots_and_images/logos/IN2P3Filaire-B_SignV_noirNB-eps-converted-to.pdf}\quad\includegraphics[trim=1cm .85cm 1cm 1cm, clip, height=.5cm]{\PhDthesisdir/plots_and_images/logos/logo_IP2I-blanc.pdf}}
\def\lowerleftlogos{}
\def\lowerrightlogos{}
...
\input{\PhDthesisdir/slides/fichier_slides_intro.tex}

%\begin{frame}
%\tableofcontents 
%\end{frame}

\input{\PhDthesisdir/slides/fichier_slides_main.tex}
...
\end{center}
\end{frame}
\input{\PhDthesisdir/slides/fichier_slides_conclusion.tex}
...
\input{\PhDthesisdir/slides/fichier_slides_backup.tex}
