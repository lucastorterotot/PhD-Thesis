...
\ifthenelse{\equal{#5}{bpt_1}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\pT$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{jeta_1}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\eta$}
}{}
...
\ifthenelse{\equal{#5}{jphi_1}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\phi$}
}{}
...
\ifthenelse{\equal{#5}{jdeta}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\Detajj$}
}{}
\ifthenelse{\equal{#5}{mjj}}{
  \def\localxaxislabel{$\mjj (\text{2 jets principaux})$ (\SI{}{\GeV})}
  \def\localyaxislabel{\Neventsaxis\ / $\dd~m$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{mt_1_puppi}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\mT$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{pZetaPuppiMissVis}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\Dzeta$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{DiTauDeltaR}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\Delta R$}
}{}
...
\ifthenelse{\equal{#5}{puppimet}}{
  ...
  \def\localyaxislabel{\Neventsaxis\ / $\dd~\MET$ (1/\SI{}{\GeV})}
}{}
...
\def\localyaxislabel{\Neventsaxis\ / $\dd~\localvar$\ifthenelse{\equal{\localvar}{\localBSMvar}}{ (1/\SI{}{\GeV})}{}}
