...
\ifthenelse{\equal{#5}{bpt_1}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\pT$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{jeta_1}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\eta$}
}{}
...
\ifthenelse{\equal{#5}{jphi_1}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\phi$}
}{}
...
\ifthenelse{\equal{#5}{jdeta}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\Detajj$}
}{}
\ifthenelse{\equal{#5}{mjj}}{
  \def\localxaxislabel{$\mjj (\text{2 jets principaux})$ (\SI{}{\GeV})}
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~m$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{mt_1_puppi}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\mT$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{pZetaPuppiMissVis}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\Dzeta$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{DiTauDeltaR}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\Delta R$}
}{}
...
\ifthenelse{\equal{#5}{puppimet}}{
  ...
  \def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\MET$ (1/\SI{}{\GeV})}
}{}
...
\ifthenelse{\equal{#5}{mt}\or\equal{#5}{et}}{
  \ifthenelse{\equal{#6}{10}}{
    \def\localcat{$\Njets=0, \mT^{\localLA} < 40$}
  }{}
  \ifthenelse{\equal{#6}{11}}{
    \def\localcat{$\Njets=0, 40 < \mT^{\localLA} < 70$}
  }{}
  \ifthenelse{\equal{#6}{12}}{
...
\ifthenelse{\equal{#5}{em}}{
  ...
  \ifthenelse{\equal{#6}{16}}{
    \def\localcat{$\Njets=1, \pT(\tau\tau) > \num{200}$}
  }{}
  \ifthenelse{\equal{#6}{17}}{
    \def\localcat{$\Njets=1, \pT(\tau\tau) < \num{40}$}
  }{}
  \ifthenelse{\equal{#6}{18}}{
    \def\localcat{$\Njets\geq2, \mjj > \num{350}$}
  }{}
  \ifthenelse{\equal{#6}{19}}{
    \def\localcat{$\Njets\geq2, \mjj < \num{350}$}
  }{}
...
\def\localyaxislabel{$\dd$~\Neventsaxis\ / $\dd~\localvar$\ifthenelse{\equal{\localvar}{\localBSMvar}}{ (1/\SI{}{\GeV})}{}}
...
\ifthenelse{\equal{#5}{mt}\or\equal{#5}{et}}{ % semi-leptonic
  \ifthenelse{\equal{#6}{20}\or\equal{#6}{13}\or\equal{#6}{15}}{
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
  \ifthenelse{\equal{#6}{16}}{
