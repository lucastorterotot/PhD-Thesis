...
\newcommand{\refApHTTshapes}{\ifref{annexe-discriminating_variables-HTT}{\ref{annexe-discriminating_variables-HTT}}{G}}
...
\ifthenelse{\equal{#5}{mt}\or\equal{#5}{et}}{
  ...
  \ifthenelse{\equal{#6}{14}}{
    \def\localcat{$\Njets=1, \Delta R \!<\! \num{2.5}, \SI{120}{\GeV} \!<\! \pT(\tau\tau) \!<\! \SI{200}$}
  }{}
  \ifthenelse{\equal{#6}{15}}{
...
\ifthenelse{\equal{#5}{em}}{
  ...
  \ifthenelse{\equal{#6}{14}}{
    \def\localcat{$\Njets=1, \SI{120} \!<\! \pT(\tau\tau) \!<\! \SI{200}$}
  }{}
  \ifthenelse{\equal{#6}{15}}{
    \def\localcat{$\Njets=1, \SI{40} \!<\! \pT(\tau\tau) \!<\! \SI{120}$}
  }{}
  \ifthenelse{\equal{#6}{16}}{
    \def\localcat{$\Njets=1, \pT(\tau\tau) \!>\! \SI{200}$}
  }{}
  \ifthenelse{\equal{#6}{17}}{
    \def\localcat{$\Njets=1, \pT(\tau\tau) \!<\! \SI{40}$}
  }{}
  \ifthenelse{\equal{#6}{18}}{
    \def\localcat{$\Njets\geq2, \mjj \!>\! \SI{350}$}
  }{}
  \ifthenelse{\equal{#6}{19}}{
    \def\localcat{$\Njets\geq2, \mjj \!<\! \SI{350}$}
  }{}
...
\ifthenelse{\equal{#5}{tt}}{ % tt
  \ifthenelse{\equal{#6}{21}\or\equal{#6}{20}\or\equal{#6}{16}}{ % fake, EMB, misc
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
  \ifthenelse{\equal{#6}{21}\and\equal{#4}{2016}}{ % 2016 fake
    \def\localCMSdisclaimerAX{3.65}
    \def\localCMSdisclaimerAY{7.05}
    \def\localCMSdisclaimerBX{5.05}
    \def\localCMSdisclaimerBY{7.05}
  }{}
  \ifthenelse{\equal{#6}{21}\and\equal{#4}{2018}}{ % 2018 fake
    \def\localCMSdisclaimerAX{3.65}
    \def\localCMSdisclaimerAY{7.05}
    \def\localCMSdisclaimerBX{5.05}
    \def\localCMSdisclaimerBY{7.05}
...
\ifthenelse{\equal{#5}{mt}\or\equal{#5}{et}}{ % semi-leptonic
  \ifthenelse{\equal{#6}{21}\or\equal{#6}{16}\or\equal{#6}{13}\or\equal{#6}{15}}{
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
  \ifthenelse{\equal{#6}{16}\and\equal{#4}{2018}}{ % 2018 misc, zll
  ...
  \ifthenelse{\equal{#6}{16}\and\equal{#4}{2016}\and\equal{#5}{et}}{ % 2016 misc in et
    \def\localCMSdisclaimerAX{6.5}
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
  \ifthenelse{\equal{#6}{21}}{ % fakes
    \def\localCMSdisclaimerAX{6.5}
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
  \ifthenelse{\equal{#6}{15}\and\equal{#4}{2016}}{ % 2016 zll
    \def\localCMSdisclaimerAX{3.65}
    \def\localCMSdisclaimerAY{7.05}
    \def\localCMSdisclaimerBX{5.05}
    \def\localCMSdisclaimerBY{7.05}
  }{}
  \ifthenelse{\equal{#6}{15}\and\equal{#4}{2018}}{ % 2018 zll
    \def\localCMSdisclaimerAX{6.5}
    \def\localCMSdisclaimerAY{7.05}
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
  \ifthenelse{\equal{#6}{15}\and\equal{#4}{2016}\and\equal{#5}{et}}{ % 2016 zll in et
    \def\localCMSdisclaimerAX{6.5}
    \def\localCMSdisclaimerAY{7.05}
    \def\localCMSdisclaimerBX{\localCMSdisclaimerAX}
    \def\localCMSdisclaimerBY{\localCMSdisclaimerAY-.55}
  }{}
%  \ifthenelse{\equal{#6}{15}\and\equal{#4}{2016}}{ % 2016 emb
%    \def\localCMSdisclaimerAX{1.95}
%    \def\localCMSdisclaimerAY{7.05}
%    \def\localCMSdisclaimerBX{3.35}
%    \def\localCMSdisclaimerBY{7.05}
