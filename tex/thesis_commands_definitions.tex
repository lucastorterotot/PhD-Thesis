...
\newcommand{\msv}{\ensuremath{m_\text{\textsc{SVfit}}}}
...
\newcommand{\Njets}{\ensuremath{N_\text{jets}}}
\newcommand{\Nbjets}{\ensuremath{N_\text{\quarkb-jets}}}
\newcommand{\Nprebjets}{\ensuremath{N_\text{pre \quarkb-jets}}}
...
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=7.85cm]{\PhDthesisdir/plots_and_images/my_plots/#1/limits/mssm/mssm_model-independent_#2_#3_#4#5.pdf}};
\fill [white] (1.5, 6) rectangle (3, 7);
\end{scope}

\def\localyaxislabelXXH{\todo{?}}
\ifthenelse{\equal{#3}{ggH}}{
  \def\localyaxislabelXXH{\ensuremath{\gluon\gluon\phi}}
}{}
\ifthenelse{\equal{#3}{bbH}}{
...
% year
\draw (7.7, 7) node [above left] {\scriptsize \SI{137}{\femto\barn^{-1}} (Run II, \SI{13}{\TeV})\vphantom{Àq,}};
...
\draw (1, 7) node [above right] {\scriptsize \localchannel\ inclusif\vphantom{Àq,}};
