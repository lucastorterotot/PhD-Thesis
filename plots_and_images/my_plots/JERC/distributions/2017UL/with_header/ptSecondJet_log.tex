...
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=8cm]{\PhDthesisdir/plots_and_images/my_plots/JERC/distributions/2017UL/source/ptSecondJet_log.pdf}};

% above txt
\fill [white] (0, 9.36) rectangle (8,9.7);
\draw (7.65, 9.5) node [left] {\footnotesize \todo{\tiny DE plots placeholders} Run 2017 BCDEF, \SI{42}{\femto\barn^{-1}} (\SI{13}{\TeV})};
