\begin{tikzpicture}
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=8cm]{\PhDthesisdir/plots_and_images/my_plots/JERC/distributions/2017UL/source/alpha_log.pdf}};

% above txt
\fill [white] (1.2, 7.31) rectangle (7.6,7.7);
\draw (7.65, 7.5) node [left] {\footnotesize \todo{\tiny DE plots placeholders} Run 2017 BCDEF, \SI{42}{\femto\barn^{-1}} (\SI{13}{\TeV})};
