...
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=8cm]{\PhDthesisdir/plots_and_images/my_plots/JERC/distributions/2018/source/JERC_application/resp_balancing_eta2530_ptPhot_175_230_with_JER.pdf}};
...
% Y axis
\foreach \val in {0, 100, ..., 600}{
\draw (1.5, {1.175+\val/600*(6.62-1.175)}) node [left] {\small $\num{\val}$};
}
