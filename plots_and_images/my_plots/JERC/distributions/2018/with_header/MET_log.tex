...
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=8cm]{\PhDthesisdir/plots_and_images/my_plots/JERC/distributions/2018/source/MET_log.pdf}};
...
\draw (1.3, {4.2+(\pos-1)/5*(9.15-4.2)}) node [left] {\small $\val$};
}
