...
\draw [CERNblue] (-.65, 2.5) node {Couche d'entrée\vphantom{Àq}};
\draw [CERNblue] (3, 2.5) node {Couches cachées\vphantom{Àq}};
\draw [CERNblue] (7.5, 2.5) node {Couche de sortie\vphantom{Àq}};
