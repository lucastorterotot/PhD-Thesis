\begin{tikzpicture}
\node[anchor=south west,inner sep=0] at (-.05,0) {\includegraphics[width=5cm]{\PhDthesisdir/plots_and_images/from_PDG_booklet_2018/parton_pdf_10000_GeV2.png}};
...
\draw (4.9,6) node [left] {\footnotesize $x_f(x, \mu^2=\SI{e4}{\GeV^2})$};
