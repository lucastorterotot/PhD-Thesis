\begin{tikzpicture}
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=5cm]{\PhDthesisdir/plots_and_images/from_PDG_booklet_2018/parton_pdf_100_GeV2.png}};
...
\draw (4.9,6) node [left] {\footnotesize $x_f(x, \mu^2=\SI{10}{\GeV^2})$};
