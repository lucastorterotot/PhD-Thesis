...
\draw (13.2, 7.10) node [right] {\scriptsize Détecteur de gerbes (\emph{PreShower})\vphantom{ÀQ}}; %Détecteur à pieds de gerbes
\draw (13.2, 6.80) node [right] {\tiny Pistes de silicium $\sim\SI{16}{\meter^2}$\vphantom{ÀQ}};
