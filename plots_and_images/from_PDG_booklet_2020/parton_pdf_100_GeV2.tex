\begin{tikzpicture}
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=5cm]{\PhDthesisdir/plots_and_images/from_PDG_booklet_2020/parton_pdf_100_GeV2.png}};
...
\draw (0, 6.9) node [above left, rotate=90] {\scriptsize $x \, f(x, \mu^2=\SI{10}{\GeV^2})$};
