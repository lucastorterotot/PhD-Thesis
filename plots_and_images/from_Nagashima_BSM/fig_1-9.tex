\begin{tikzpicture}
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=8cm]{\PhDthesisdir/plots_and_images/from_Nagashima_BSM/fig_1-9.png}};
...
% Notations
\draw (0, 8.45) node [left, rotate=90] {\small $m_\Phi$ (\SI{}{\GeV})} ;
\draw (3.7, 7.25) node {\small $X_t = \sqrt{6} m_S$} ;
\draw (3.5, 6.6) node [left] {\small $\tan\beta = 3$} ;
\draw (3.5, 6.2) node [left] {\small $\tan\beta = 30$} ;
\draw (1.5, 4.85) node {\small $\Phi=\Higgs$} ;
\draw (1.5, 2.85) node {\small $\Phi=\Higgspm$} ;
\draw (7, 4.6) node {\small $\Phi=\higgs$} ;
