\def\trackerrin{.100}
\def\trackerrout{1.185} % from eta-ranges pict
\def\trackercolor{ltcolorgray1}

\def\ECALrin{1.290} % from eta-ranges pict
\def\ECALrout{1.811} % from eta-ranges pict
\def\ECALcolor{ltcolorgreen1}

\def\HCALrin{1.812}
\def\HCALrout{2.854} % from eta-ranges pict
\def\HCALcolor{ltcoloryellow3}

\def\Solenrin{2.950} % from eta-ranges pict
\def\Solenrout{3.800} % from eta-ranges pict
\def\Solencolor{ltcolorgray2}

\def\steelryrina{3.850}
\def\steelryrouta{4.000}
\def\muonrina{4.020} % from eta-ranges pict
\def\muonrouta{4.400}
\def\steelryrinb{4.550}
\def\steelryroutb{4.870}
\def\muonrinb{4.905} % from eta-ranges pict
\def\muonroutb{5.285}
\def\steelryrinc{5.355}
\def\steelryroutc{5.905}
\def\muonrinc{5.975} % from eta-ranges pict
\def\muonroutc{6.355}
\def\steelryrind{6.425}
\def\steelryroutd{6.930}
\def\muonrind{7.000} % from eta-ranges pict
\def\muonroutd{7.380} % from eta-ranges pict
\def\muonchcolor{ltcoloryellow1}
\def\steelrycolor{ltcolorred3}

\def\clipCircle#1#2{
\clip (#1,0) arc (0:360:#1) -- (#2,0) arc (360:0:#2) -- cycle ;
}
\def\clipInTRK{\clipCircle{\trackerrin}{\trackerrout}}
\def\clipInECAL{\clipCircle{\ECALrin}{\ECALrout}}
\def\clipInHCAL{\clipCircle{\HCALrin}{\HCALrout}}
\def\clipECAL{\clip (0,0) circle (\ECALrout);}
\def\clipHCAL{\clip (0,0) circle (\HCALrout);}
...
\steelryrind/\steelryroutd/\steelrycolor,
\muonrinc/\muonroutc/\muonchcolor,
\steelryrinc/\steelryroutc/\steelrycolor,
\muonrinb/\muonroutb/\muonchcolor,
\steelryrinb/\steelryroutb/\steelrycolor,
\muonrina/\muonrouta/\muonchcolor
%\steelryrina/\steelryrouta/\steelrycolor
}{
\begin{scope}
\clipMuCh{\rin}{\rout}
...
\begin{scope}
\clipECAL
\draw [thick, \elecolor] \CurrentVertex arc (#1-90:#1-90+27:3);
\end{scope}
}
...
\draw [thick, \muoncolor]  \CurrentVertex arc (#1-90:#1-90+33:6) arc (#1-90+33:#1-90:-12) ;
}
...
\begin{scope}
\clipECAL
\draw [thin, dashed, \photoncolor] \CurrentVertex --+ (#1:{.5*(\ECALrin+\ECALrout)});
\end{scope}
}
...
\draw [thin, dotted, black] \CurrentVertex --+ (#1:{1.5*\muonroutd});
}
...
\begin{scope}
\clipHCAL
\draw [thick, \hadroncolor] \CurrentVertex arc (#1+90:#1+90-22:5) ;
\end{scope}
}
...
\begin{scope}
\clipHCAL
\draw [thin, dashed, \hadroncolor] \CurrentVertex --+ (#1:{.5*(\HCALrin+\HCALrout)});
\end{scope}
}
...
\begin{scope}
\clipECAL
\draw [thin, dashed, \tauhcolor] \CurrentVertex --+ (#2:{.5*(\ECALrin+\ECALrout)});
\draw [thin, dashed, \tauhcolor] \CurrentVertex --+ (#2+7:{.5*(\ECALrin+\ECALrout)});
\end{scope}
}{}
\begin{scope}
\clipHCAL
\ifthenelse{\equal{#1}{10}\or\equal{#1}{11}}{}{
\draw [thick, \tauhcolor] \CurrentVertex arc (#2-90:#2-90+11:10) ;
\draw [thick, \tauhcolor] \CurrentVertex arc (#2-90:#2-90-11:-10) ;
}
\draw [thick, \tauhcolor] \CurrentVertex arc (#2-90:#2-90+6:20) ;
\end{scope}
}
...
\begin{scope}
\clipHCAL
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90+10:#1-90+22+10:5) ;
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90+5:#1-90+12+5:10) ;
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90:#1-90-22:-5) ;
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90:#1-90+6:20) ;
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90+5:#1-90+8+5:10) ;
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90:#1-90-11:-10) ;
\draw [thick, \jetcolor] \CurrentVertex arc (#1-90:#1-90+11:10) ;
\end{scope}
\begin{scope}
\clipECAL
\draw [thick, \jetcolor] \CurrentVertex arc (#1+2-90:#1+2-90-27:-3); % antielectron
\draw [thick, \jetcolor] \CurrentVertex arc (#1-1-90:#1-1-90+27:3); % electron
\end{scope}
}
...
\begin{scope}
\clipHCAL
\draw [thick, \tauhcolor] \CurrentVertex arc (#1-90:#1-90+11:10) ;
\draw [thick, \tauhcolor] \CurrentVertex arc (#1-90:#1-90+6:20) ;
\draw [thick, \tauhcolor] \CurrentVertex arc (#1-90:#1-90-11:-10) ;
\end{scope}
}
...
\begin{scope}
\clipMuCh{#3}{#4}
\fill [\MuChdepositcolor] \CurrentVertex + (#1+90:-.075) arc (#1-90:#1-90+33*#2:6*#2) arc (#1-90+33*#2:#1-90:-12*#2) -- + (#1+90:.15) arc (#1-90:#1-90+33*#2:-12*#2) arc (#1-90+33*#2:#1-90:6*#2) -- cycle ;
\end{scope}
}
...
\begin{scope}
\clipInTRK
\draw [very thick, dotted] \CurrentVertex arc (#1-90:#1-90+27:3);
\end{scope}
}
...
\begin{scope}
\clipInTRK
\draw [very thick, dotted]  \CurrentVertex arc (#1-90:#1-90+33:6) arc (#1-90+33:#1-90:-12) ;
\end{scope}
}
...
\begin{scope}
\clipInTRK
\draw [very thick, dotted] \CurrentVertex arc (#1+90:#1+90-22:5) ;
\end{scope}
}
