...
de m'avoir fait découvrir tous les outils que j'ai utilisés dans ma thèse.
...
sans lesquelles je n'aurais pas pu les prendre en main aussi rapidement.
...
dont la topologie différente de ceux que j'ai étudiés nous montre son comportement dans cette situation inédite.
\par
...
\par
Merci à Antoine C., pour ton parrainage, les discussions que nous avons eues
