...
Le potentiel de Higgs~\eqref{eq-chapter-MS-MSSM-section-formalisme-subsec-Higgs_mechanism-SM_Higgs_potential} du modèle standard est remplacé par le potentiel scalaire le plus général possible\footnote{Des facteurs $\frac{1}{2}$ ont été introduits par rapport à~\cite{Higgs_hunter_guide,Higgs_hunter_guide_errata} afin de conserver une cohérence sur les définitions de $v_1$ et $v_2$ vis-à-vis de la section~\ref{chapter-MS-MSSM-section-formalisme-subsec-Higgs_mechanism} tout en conservant la physique inchangée.} brisant spontanément $SU(2)_L \times U(1)_Y$ en $U(1)_{em}$~\cite{Higgs_hunter_guide,Higgs_hunter_guide_errata},
\begin{multline}
V(\phi_1,\phi_2)
...
La présence de nombreux paramètres libres du MSSM mène à proposer des \og scénario \fg{} dans lesquels les paramètres intervenant dans les corrections d'ordres supérieurs sont fixés~\cite{Carena_2013}.
...
\begin{figure}[h]
\centering
\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-MS-MSSM/plots/from_Nagashima_BSM/fig_1-9.tex}
