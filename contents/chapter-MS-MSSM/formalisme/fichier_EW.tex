...
La section efficace d'un processus physique ainsi que son lien avec le nombre d'événements de ce processus est abordé dans la section~\ifref{chapter-LHC-section-LHC-subsec-lumi}{\ref{chapter-LHC-section-LHC-subsec-lumi}}{3.4} du chapitre~\ifref{chapter-LHC}{\ref{chapter-LHC}}{3}.
