...
\end{equation}
où $\bm{\lambda}$ est un vecteur à huit composantes, chacune étant une matrice de Gell-Mann, définies dans l'annexe~\ifref{annexe-maths}{\ref{annexe-maths}}{A}, $\bm{G}_\mu$ décrit donc huit gluons, bosons vecteurs de l'interaction forte et $\alpha_s$ est la constante de couplage de l'interaction forte.
...
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QCD/fgraph-qgq.tex}\vspace{\baselineskip}}
\hfill
...
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QCD/fgraph-qgq_colors_and_anticolors.tex}\vspace{\baselineskip}}
...
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QCD/fgraph-ggg.tex}\vspace{\baselineskip}}
\hfill
\subcaptionbox{\label{subfig-fgraph-gggg}}[.45\textwidth]
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QCD/fgraph-gggg.tex}\vspace{\baselineskip}}
...
En effet, ce terme est responsable du confinement de couleur et de l'initiation de la gerbe partonique qui donne naissance aux jets, ce qui est discuté dans le chapitre~\ifref{chapter-JERC}{\ref{chapter-JERC}}{4}.
...
Cette diminution de $\alpha_s$ aux hautes énergies est la \og liberté asymptotique \fg~\cite{QCD_asymptotic_freedom_1,QCD_asymptotic_freedom_2}, régime où les particules colorées ne sont plus confinées et peuvent se propager comme des particules libres. Aux LHC, les énergies de collision permettent d'atteindre ce régime.
