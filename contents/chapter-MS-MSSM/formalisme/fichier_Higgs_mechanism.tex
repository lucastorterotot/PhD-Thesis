...
\mend
\end{align}
Ces équations peuvent être réécrite en introduisant l'angle de mixage faible\footnote{L'angle de mixage faible est également connu sous le nom d'angle de Weinberg.} noté $\theta_W$~\cite{GLASHOW1961579}, tel que
\begin{equation}
