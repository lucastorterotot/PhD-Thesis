...
\par
Le minimum de potentiel pour $V$ dégénéré, \ie\ qu'il y a une infinité de points correspondant au minimum de $V$.
...
\mend
\end{align}
Cette combinaison étant fixée par la construction d'une matrice unitaire $\mathcal{M}_{\photon\Zboson}$ reliant les champs
$A_\mu$ et $Z_\mu$
à
$B_\mu$ et $W_\mu^3$,
\begin{equation}
