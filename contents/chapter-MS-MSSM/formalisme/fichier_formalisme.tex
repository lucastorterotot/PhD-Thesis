...
Le comportement des particules fondamentales est obtenu par application des équations d'Euler-Lagrange au lagrangien du modèle standard.
...
\par 
La trajectoire de cette particule peut être déterminée à l'aide du principe fondamental de la dynamique, ou seconde loi de Newton, qui s'exprime dans ce cas sous la forme
\begin{equation}
m\dv[2]{x}{t} = F
\mend
\end{equation}
...
\input{\PhDthesisdir/contents/chapter-MS-MSSM/formalisme/fichier_QED.tex}
\input{\PhDthesisdir/contents/chapter-MS-MSSM/formalisme/fichier_EW.tex}
\input{\PhDthesisdir/contents/chapter-MS-MSSM/formalisme/fichier_Higgs_mechanism.tex}
\input{\PhDthesisdir/contents/chapter-MS-MSSM/formalisme/fichier_QCD.tex}
\input{\PhDthesisdir/contents/chapter-MS-MSSM/formalisme/formation_des_jets/fichier_formation_des_jets.tex}
