...
%\draw (-90:\overlappct*\rcircle+0*\rcircle) node {anti-rouge} ;
%\draw (-90-120:\overlappct*\rcircle+0*\rcircle) node [rotate=60] {anti-bleu} ;
%\draw (-90+120:\overlappct*\rcircle+0*\rcircle) node [rotate=-60] {anti-vert} ;
