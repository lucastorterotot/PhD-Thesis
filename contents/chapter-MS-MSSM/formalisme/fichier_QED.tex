...
\par Le lagrangien $\Lcal_{\text{fermion libre}}$ est invariant sous une transformation globale du groupe $U(1)_{em}$\footnote{Dans la notation $U(1)_{em}$, \og $em$ \fg{} signifie électromagnétique. Ce groupe n'apparaît pas dans l'équation~\eqref{eq-symmetries_lagrangien_SM} car seul l'électromagnétisme est traité ici. Le groupe $U(1)_Y$ est traité dans la section~\ref{chapter-MS-MSSM-section-formalisme-subsec-EW}.}, \ie\ lorsque la transformation suivante est appliquée au spineur $\psi$
\begin{equation}
...
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QED/fgraph-ff_Gamma1.tex}\vspace{\baselineskip}}
\hfill
\subcaptionbox{Un photon donne une paire de fermion et antifermion.\label{subfig-fgraph-ff_Gamma2}}[.225\textwidth]
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QED/fgraph-ff_Gamma2.tex}\vspace{\baselineskip}}
\hfill
\subcaptionbox{Un fermion interagit avec un photon.\label{subfig-fgraph-ff_Gamma3}}[.225\textwidth]
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QED/fgraph-ff_Gamma3.tex}\vspace{\baselineskip}}
\hfill
\subcaptionbox{Un antifermion interagit avec un photon.\label{subfig-fgraph-ff_Gamma4}}[.225\textwidth]
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QED/fgraph-ff_Gamma4.tex}\vspace{\baselineskip}}
