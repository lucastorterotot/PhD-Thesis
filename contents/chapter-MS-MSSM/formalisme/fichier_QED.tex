...
Toutefois, le champ $A_\mu$ ne représente pas encore le photon en l'état, il faut permettre au photon de se propager librement. Pour cela, un terme cinétique qui soit invariant de jauge dans le lagrangien doit être introduit, ce qui peut se faire avec
\begin{equation}
