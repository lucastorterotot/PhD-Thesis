...
\draw (-90:\overlappct*\rcircle+.5*\rcircle) node {anti-rouge} ;
\draw (-90+120:\overlappct*\rcircle+.5*\rcircle) node [rotate=-60] {anti-vert} ;
\draw (-90-120:\overlappct*\rcircle+.5*\rcircle) node [rotate=60] {anti-bleu} ;
