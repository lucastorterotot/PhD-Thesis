...
\end{itemize}
\par Dans le cas de la désintégration hadronique, le phénomène d'hadronisation\footnote{L'hadronisation est présentée dans la section~\ifref{chapter-JERC-section-jets-subsec-hadronisation}{\ref{chapter-JERC-section-jets-subsec-hadronisation}}{2.2} du chapitre\ifref{chapter-JERC}{~\ref{chapter-JERC}}{ \og Calibration en énergie des jets \fg{}}.} a lieu et les deux quarks donnent un ensemble constitué de quelques hadrons, en général trois ou moins, et éventuellement des particules neutres comme des \pionnull, ces derniers se désintégrant majoritairement en deux photons.
