...
\par
Dans cette annexe,
les valeurs prises par ces paramètres après ajustement
pour l'obtention des limites d'exclusion indépendantes du modèle
$\hat{\theta}$ (\emph{pulls})
ainsi que l'incertitude sur cette valeur
sont données en termes de nombre de déviations standard $\Delta \theta$
