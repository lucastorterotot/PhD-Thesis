\section{Reconstruction des jets}\label{chapter-HLO-section-jets_reco}
...
\subsection{Algorithmes de regroupement}\label{chapter-HLO-section-jets_reco-subsec-algo}
...
Les émissions de partons sont plus importantes pour de basses énergies (limite infrarouge) ou pour un parton émis colinéaire au parton initial (limite colinéaire), comme discuté dans la section~\ref{chapter-HLO-section-jets}.
...
Un exemple de reconstruction de jets à l'aide de l'algorithme \textsc{SISCone} est présenté sur la figure~\ref{fig-chapter-HLO-section-jets_reco-subsec-algo-examples}.
\begin{figure}[h]
\centering
...
\label{fig-chapter-HLO-section-jets_reco-subsec-algo-examples}
\end{figure}
...
%Cet algorithme a l'avantage de regrouper les particules très fidèlement vis-à-vis de la gerbe hadronique, mais les jets obtenus possèdent une géométrie spatiale irrégulière, comme cela se voit sur la figure~\ref{fig-chapter-HLO-section-jets_reco-subsec-algo-examples}.
...
Cet algorithme propose un regroupement des particules moins fidèle à la gerbe hadronique, mais produit des jets de forme régulière, comme cela se voit sur la figure~\ref{fig-chapter-HLO-section-jets_reco-subsec-algo-examples}.
\end{description}
\par Le temps de calcul de ces algorithmes est un enjeu majeur au LHC.
Leurs temps d'exécution sont représentés en fonction du nombre d'interactions d'empilement sur la figure~\ref{fig-chapter-HLO-section-jets_reco-subsec-algo-perfs}.
...
\label{fig-chapter-HLO-section-jets_reco-subsec-algo-perfs}
\end{figure}
\begin{figure}[h]
\centering
...
\par Les critères utilisés pour les années 2016, 2017, 2018, 2017-UL et 2018-UL, listés page~\pageref{tab-chapter-HLO-section-jets_reco-subsec-jetID-2017UL}, permettent d'obtenir une efficacité d'identification des jets supérieure à \SI{99}{\%} dans chacune des régions en $\eta$ du détecteur.
...
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-HLO/reconstruction_des_jets/JetIDs/2016.tex}
...
\label{tab-chapter-HLO-section-jets_reco-subsec-jetID-2016}
\end{table}
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-HLO/reconstruction_des_jets/JetIDs/2017.tex}
...
\label{tab-chapter-HLO-section-jets_reco-subsec-jetID-2017}
\end{table}
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-HLO/reconstruction_des_jets/JetIDs/2018.tex}
...
\label{tab-chapter-HLO-section-jets_reco-subsec-jetID-2018}
\end{table}
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-HLO/reconstruction_des_jets/JetIDs/2017UL.tex}
...
\label{tab-chapter-HLO-section-jets_reco-subsec-jetID-2017UL}
\end{table}
\subsection{Saveur des jets}\label{chapter-HLO-section-jets_reco-subsec-flavor}
...
Pour chacune d'entre elles, il est possible de déterminer le paramètre d'impact (IP) au vertex primaire, dont la valeur est typiquement plus grande que pour des traces provenant du vertex primaire, comme cela est illustré sur la figure~\ref{fig-chapter-HLO-section-jets_reco-subsec-flavor-SV_scheme}.
\begin{figure}[h]
\centering
...
\label{fig-chapter-HLO-section-jets_reco-subsec-flavor-SV_scheme}
\end{figure}
...
\subcaptionbox{Probabilité de mauvaise identification en tant que jet de quark~\quarkb\ de jets de gluon ou quarks légers (traits pleins) ou de jets de quark~\quarkc\ (pointillés) en fonction de l'efficacité d'identification des jets de quark~\quarkb.\label{subfig-chapter-HLO-section-jets_reco-subsec-flavor-b_or_mis}}[.75\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/plots_and_images/from_Sirunyan_heavy_flavor_jets_2018/b_or_mis.png}}

\vspace{\baselineskip}

\subcaptionbox{Probabilité de mauvaise identification en tant que jet de quark~\quarkc\ de jets de gluon ou quarks légers en fonction de l'efficacité d'identification des jets de quark~\quarkc.\label{subfig-chapter-HLO-section-jets_reco-subsec-flavor-c_or_mis}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/plots_and_images/from_Sirunyan_heavy_flavor_jets_2018/c_or_mis.png}}
\hfill
\subcaptionbox{Probabilité de mauvaise identification en tant que jet de quark~\quarkb\ de jets de quark~\quarkc en fonction de l'efficacité d'identification des jets de quark~\quarkc.\label{subfig-chapter-HLO-section-jets_reco-subsec-flavor-c_or_b}}[.45\textwidth]
...
\label{fig-chapter-HLO-section-jets_reco-subsec-flavor-bc_tag_roc_curves}
\end{figure}
\begin{figure}[p]
\centering
...
\label{fig-chapter-HLO-section-jets_reco-subsec-flavor-qgl_likelihood}
\end{figure}
\par Les performances ainsi obtenues pour l'algorithme \DeepCSV\ sont comparées à d'autres algorithmes d'identification de la saveur des jets sur la figure~\ref{fig-chapter-HLO-section-jets_reco-subsec-flavor-bc_tag_roc_curves}.
...
\subsubsection{Correction de l'efficacité du \quarkb-\emph{tagging}}
