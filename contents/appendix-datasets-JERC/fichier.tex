...
Cette annexe présente les jeux de données utilisés pour les analyses du chapitre~\refChJERC.
...
\up{1}\inlinecode{bash}{/RunIIAutumn18MiniAOD-102X_upgrade2018_realistic_v15-v1/MINIAODSIM}
\end{flushleft}
...
\end{tabular}
\begin{flushleft}\footnotesize
\up{1}\inlinecode{bash}{/RunIISummer19UL17MiniAOD-106X_mc2017_realistic_v6-v1/MINIAODSIM}\\
\up{2}\inlinecode{bash}{/RunIISummer19UL17MiniAOD-4cores5k_106X_mc2017_realistic_v6-v1/MINIAODSIM}
\end{flushleft}
