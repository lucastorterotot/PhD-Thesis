...
\draw (equal.west) node [left] {\ \ \input{\PhDthesisdir/plots_and_images/Feynman_diagrams/ee_to_ee_smalls/fgraph-ee_to_ee_global.tex}\ \ };

\draw (equal.east) node (d1) [right] {\ \ \input{\PhDthesisdir/plots_and_images/Feynman_diagrams/ee_to_ee_smalls/fgraph-ee_gamma_ee_t.tex}\ \ };
...
\draw (p.east) node (d) [right] {\ \ \input{\PhDthesisdir/plots_and_images/Feynman_diagrams/ee_to_ee_smalls/fgraph-ee_Z_ee_s.tex}\ \ };
%\draw (d.east) node (p) [right] {\Large +};
%\draw (p.east) node (d) [right] {\ldots};

\draw (equal.south east)+(0,-6\baselineskip) node (p) {\Large +};
\draw (p.east) node (d) [right] {\ \ \input{\PhDthesisdir/plots_and_images/Feynman_diagrams/ee_to_ee_smalls/fgraph-ee_WW_ee_1.tex}\ \ };
\draw (d.east) node (p) [right] {\Large +};
\draw (p.east) node (d) [right] {\ \ \input{\PhDthesisdir/plots_and_images/Feynman_diagrams/ee_to_ee_smalls/fgraph-ee_WW_ee_2.tex}\ \ };
\draw (d.east) node (p) [right] {\Large +};
\draw (p.east) node (d) [right] {\ldots};
\end{tikzpicture}
\vspace{\baselineskip}
...
\centering
\vspace{\baselineskip}
\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/QED/fgraph-ff_Gamma1-large_with_annotations.tex}
\vspace{\baselineskip}
...
Par exemple, dans le cas de l'interaction électromagnétique abordée dans le chapitre~\refChMSSM, un des termes du lagrangien est
\begin{equation}
