...
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2016_MC_signal_SM.tex}
\caption{Jeux de données simulées utilisés pour modéliser le signal issu du modèle standard dans l'analyse $\Higgs\to\tau\tau$ en 2016.}
\label{tab-annexe-datasets-HTT-2016_MC_signal_SM}
\end{table}
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2017_MC_signal_SM.tex}
\caption{Jeux de données simulées utilisés pour modéliser le signal issu du modèle standard dans l'analyse $\Higgs\to\tau\tau$ en 2017.}
\label{tab-annexe-datasets-HTT-2017_MC_signal_SM}
\end{table}
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2018_MC_signal_SM.tex}
\caption{Jeux de données simulées utilisés pour modéliser le signal issu du modèle standard dans l'analyse $\Higgs\to\tau\tau$ en 2018.}
\label{tab-annexe-datasets-HTT-2018_MC_signal_SM}
\end{table}

\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2016_MC_signal_MSSM.tex}
\caption{Jeux de données simulées utilisés pour modéliser le signal issu du MSSM dans l'analyse $\Higgs\to\tau\tau$ en 2016.}
\label{tab-annexe-datasets-HTT-2016_MC_signal_MSSM}
\end{table}
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2017_MC_signal_MSSM.tex}
\caption{Jeux de données simulées utilisés pour modéliser le signal issu du MSSM dans l'analyse $\Higgs\to\tau\tau$ en 2017.}
\label{tab-annexe-datasets-HTT-2017_MC_signal_MSSM}
\end{table}
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2018_MC_signal_MSSM.tex}
\caption{Jeux de données simulées utilisés pour modéliser le signal issu du MSSM dans l'analyse $\Higgs\to\tau\tau$ en 2018.}
\label{tab-annexe-datasets-HTT-2018_MC_signal_MSSM}
\end{table}

\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2016_MC_backgrounds.tex}
\caption{Jeux de données simulées utilisés pour modéliser le bruit de fond de l'analyse $\Higgs\to\tau\tau$ en 2016.}
\label{tab-annexe-datasets-HTT-2016_MC_backgrounds}
\end{table}
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2017_MC_backgrounds.tex}
\caption{Jeux de données simulées utilisés pour modéliser le bruit de fond de l'analyse $\Higgs\to\tau\tau$ en 2017.}
\label{tab-annexe-datasets-HTT-2017_MC_backgrounds}
\end{table}
\begin{table}[p]
\centering
\input{/home/torterotot/Documents/PhD-Thesis/contents/appendix-datasets-HTT/tables/datasets-HTT-2018_MC_backgrounds.tex}
\caption{Jeux de données simulées utilisés pour modéliser le bruit de fond de l'analyse $\Higgs\to\tau\tau$ en 2018.}
