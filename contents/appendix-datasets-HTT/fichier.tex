...
L'analyse du chapitre~\refChHTT\ est basée sur les données à $\sqrt{s}=\SI{13}{\TeV}$ collectées en 2016, 2017 et 2018 par l'expérience CMS, correspondant à une luminosité intégrée de $\num{35.9}+\num{41.5}+\SI{59.7}{\femto\barn^{-1}}$.
...
et
$\gluon\gluon\to\quarkb\quarkb\Phi\to\tau\tau$ simulé avec \POWHEG~\cite{Alioli:2010xd} et \PYTHIA~\cite{pythia6.4,pythia8.2} pour l'hadronisation.
...
Ces jeux de données sont utilisés dans une estimation du bruit de fond contenant des paires de leptons~\tau\ à partir des données elles-mêmes.
...
\caption{Jeux de données simulées modélisant les bosons de Higgs du MSSM en 2016.}
...
\caption{Jeux de données simulées modélisant les bosons de Higgs du MSSM en 2017.}
...
\caption{Jeux de données simulées modélisant les bosons de Higgs du MSSM en 2018.}
