...
$\gluon\gluon\to\Phi\to\tau\tau$ & \inlinecode{bash}{/SUSYGluGluToHToTauTau_M-*_TuneCUETP8M1_13TeV-powheg-pythia8}\up{1} \\ 
$\gluon\gluon\to\quarkb\quarkb\Phi\to\tau\tau$ & \inlinecode{bash}{/SUSYGluGluToBBHToTauTau_M-*_TuneCUETP8M1_13TeV-powheg-pythia8}\up{1} \\
\bottomrule
\end{tabular}
