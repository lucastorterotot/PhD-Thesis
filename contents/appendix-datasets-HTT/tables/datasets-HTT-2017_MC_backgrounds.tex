...
EWK \Wbosonminus & \inlinecode{bash}{/EWKWMinus2Jets_WToLNu_M-50}\up{$\diamond$}\up{2} & $\num{23.24}$ (LO) \\
EWK \Wbosonplus & \inlinecode{bash}{/EWKWPlus2Jets_WToLNu_M-50}\up{$\diamond$}\up{2} & $\num{29.59}$ (LO) \\
EWK $\Zboson\to LL$ & \inlinecode{bash}{/EWKZ2Jets_ZToLL_M-50}\up{$\diamond$}\up{2} & $\num{4.321}$ (LO) \\
EWK $\Zboson\to \nu\nu$ & \inlinecode{bash}{/EWKZ2Jets_ZToNuNu}\up{$\diamond$}\up{2} & $\num{10.66}$ (LO) \\
