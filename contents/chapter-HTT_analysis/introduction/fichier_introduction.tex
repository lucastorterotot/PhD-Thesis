...
ces derniers offrent une meilleure accessibilité expérimentale dans les collisionneurs hadroniques comme le Tevatron,
...
Les simulations n'étant pas exemptes de défauts, des corrections déterminées à l'aide d'analyses annexes leurs sont appliquées.
...
\par
Une note d'analyse \cite{CMS-NOTE-2020-218} interne à la collaboration CMS est déjà disponible et un article est en préparation~\cite{HIG-21-001}.
Ces travaux sont réalisés au sein d'une équipe regroupant:
\begin{itemize}
\item l'Institut de Physique des 2 Infinis (IP2I) de l'Université Claude Bernard de Lyon;
