...
À partir des signaux réels comme simulés, des objets physiques sont reconstruits comme exposé dans le chapitre~\refChLHCCMS.
Leur sélection est présentée dans la section~\ref{chapter-HTT_analysis-section-objects}.
Les simulations n'étant pas exemptées de défauts, des corrections leurs sont appliquées.
Elles sont déterminées à l'aide d'analyses annexes et listées dans la section~\ref{chapter-HTT_analysis-section-corrections}.
