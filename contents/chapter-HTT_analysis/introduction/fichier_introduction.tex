...
À partir des signaux réels comme simulés, des objets physiques sont reconstruits comme exposé dans les chapitres~\refChLHCCMS\ et~\refChHLO.
...
Ces corrections sont introduites dans la section~\ref{chapter-HTT_analysis-section-corrections}.
