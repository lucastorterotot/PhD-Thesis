...
début thèse et HEPPY avec Gael (citer these), cross-checks. À cette occasion, bug de Combine.
...
\todo{évoquer aussi les données encapsulées (car évoquées dans corrections)}\\
