...
Elle rend l'analyse plus sensible aux propriétés du boson de Higgs du modèle standard \higgs, celles-ci pouvant être modifiées dans le MSSM par rapport au modèle standard, comme exposé dans le chapitre~\refChMSSM.
