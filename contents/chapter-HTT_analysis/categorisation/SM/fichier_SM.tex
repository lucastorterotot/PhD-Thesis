...
Pour chaque canal, en plus d'une catégorie \og signal \fg, une catégorie est définie pour chaque bruit de fond suffisamment présent.
...
$\Zboson\to\ell\ell$, \ttbar, \Wjets, Diboson, \emph{Single-top} et EWK dans le canal \tauh\tauh;
Diboson, \emph{Single-top} et EWK dans les canaux \mu\tauh\ et \ele\tauh;
$\Zboson\to\ell\ell$ et \Wjets\ dans le canal \ele\mu.
\begin{table}[h]
\centering
\begin{tabular}{ccccccc}
\toprule
Canal & \multicolumn{6}{l}{Catégories possibles}\\
\midrule
