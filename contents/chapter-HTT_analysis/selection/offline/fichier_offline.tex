\subsection{Obtention du dilepton}\label{chapter-HTT_analysis-section-offline_selection}
...
Un seul des dileptons candidats est retenu selon la logique exposée dans la section~\ref{chapter-HTT_analysis-section-offline-dilepton}.
\par
...
\subsubsection{Sélection d'un unique dilepton}\label{chapter-HTT_analysis-section-offline-dilepton}
Il est possible d'obtenir plusieurs candidats dilepton après application des coupures précédemment exposées.
