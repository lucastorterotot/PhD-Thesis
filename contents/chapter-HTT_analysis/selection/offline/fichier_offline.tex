...
\begin{itemize}
    \item $\pT^{\mu} > \num{23} \, (\num{25}) \usp \SI{}{\GeV}$ en 2016 (2017, 2018) et corresponde à l'objet HLT du \HLTpath\ \HLTSingleMu{} ou $\num{20 (21)} < \pT^{\mu} \leq \num{23} \, (\num{25}) \usp \SI{}{\GeV}$ en 2016 (2017, 2018) et corresponde à l'objet HLT de type muon du \HLTpath\ \HLTMuTauCross{};
    \item $\abs{\eta^{\mu}} < \num{2.1}$;
    \item \Leptondzdxy;
...
\end{itemize}
Dans le cas de l'utilisation du \HLTpath\ \HLTSingleTau{}, le tau hadronique doit de plus:
\begin{itemize}
    \item correspondre à l'objet HLT;
    \item $\pT^{\tauh} > \num{25} \, (\num{32}) \usp \SI{}{\GeV}$ en 2016 (2017, 2018).
\end{itemize}
\paragraph{Masse transverse du muon}
\TransverseMassWjets[footnote]{du muon}.
\paragraph{Vétos de leptons supplémentaires}
\LeptonVetoes
\begin{itemize}
...
\begin{itemize}
    \item $\pT^{\ele} > \SI{26}{\GeV}$ en 2016, \num{28} en 2017 et \num{33} en 2018 et corresponde à l'objet HLT du \HLTpath\ \HLTSingleEle{} ou $\pT^{\ele} > \SI{25}{\GeV}$ et la valeur précédente et corresponde à l'objet HLT de type électron du \HLTpath\ \HLTEleTauCross{};
    \item $\abs{\eta^{\ele}} < \num{2.1}$;
    \item \Leptondzdxy;
...
\begin{itemize}
    \item bas \pT: $\pT^{\tauh} < \num{120} \, (\num{180}) \usp \SI{}{\GeV}$ en 2016 (2017, 2018).
        Une combinaison logique \og ou \fg{} des \HLTpaths\ \HLTSingleEle{} et \HLTMuTauCross{} est considérée;
    \item haut \pT: $\pT^{\tauh} > \num{120} \, (\num{180}) \usp \SI{}{\GeV}$ en 2016 (2017, 2018).
...
\TransverseMassWjets{de l'électron}
\paragraph{Vétos de leptons supplémentaires}
\LeptonVetoes
\begin{itemize}
    \item \LeptonVetoesExtraMuon;
