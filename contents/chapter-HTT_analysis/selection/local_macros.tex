...
\newcommand{\MuonIDWP}[2]{point de fonctionnement #1 (\emph{#2}) du \emph{muonID}}
\newcommand{\MediumMuonID}{\MuonIDWP{moyen}{medium}}
\newcommand{\LooseMuonID}{\MuonIDWP{relâché}{loose}}

\newcommand{\NinetyNineEleMVA}{point de fonctionnement à \SI{90}{\%} d'efficacité de l'\emph{electron ID MVA}}
...
\renewcommand{\MuonIDWP}[2]{point de fonctionnement \emph{#2} du \emph{muonID}}
