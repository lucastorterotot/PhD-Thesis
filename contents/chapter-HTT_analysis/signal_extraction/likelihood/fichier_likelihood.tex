...
\begin{description}
\item[Z] $x_i = 0$ et $e_i = 0$ (processus non présent dans le segment) ou $e_i/x_i$ inférieur à \inlinecode{cpp}{AddThreshold}, non traités par la procédure de regroupement;
