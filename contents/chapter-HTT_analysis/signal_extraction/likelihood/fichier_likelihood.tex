...
\paragraph{Principe}
L'incertitude statistique dans les distributions des variables discriminantes est prise en compte par la méthode de Barlow-Beeston~\cite{BarlowBeeston,BarlowBeeston2}.
