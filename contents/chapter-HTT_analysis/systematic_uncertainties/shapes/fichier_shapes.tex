...
Une corrélation de \SI{50}{\%} entre données simulées et encapsulées est utilisée, l'encapsulation étant un hybride entre données réelles et simulées.
...
Les incertitudes de forme dues à la statistique des bruits de fond suite à l'utilisation conjointe des données simulées, encapsulées et réelles dans leur estimation sont prises en compte par la fonction \inlinecode{bash}{autoMCstats} de \COMBINE.
