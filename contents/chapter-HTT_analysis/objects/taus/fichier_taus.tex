...
\subsubsection{Obtention d'un candidat tau hadronique}
Les hadrons chargés contenus dans le jet initial tels que $\pT>\SI{0.5}{\GeV}$ et de paramètre d'impact transverse $d_{xy}<\SI{0.1}{\centi\meter}$ vis-à-vis du vertex primaire principal sont utilisés pour former un \tauh.
\par
...
Ces cas de figure sont largement contaminés par le bruit de fond \og QCD multijet \fg, il sont donc rejetés dans l'analyse.
\begin{table}[h]
\centering
\begin{tabular}{clc}
\toprule
