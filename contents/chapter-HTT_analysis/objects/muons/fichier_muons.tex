...
En particulier, le \emph{Medium} \muonID\ est utilisé dans les canaux \mu\tauh, \ele\tauh\ et \ele\mu\ de l'analyse, comme le recommande le \POG\ (\emph{Physics Object Group}, groupe responsable d'un objet physique) Muons~\cite{cmsMediumMuon}.
