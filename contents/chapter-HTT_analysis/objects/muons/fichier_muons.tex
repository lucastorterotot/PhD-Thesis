...
Il est possible de définir un critère de qualité sur l'objet reconstruit devant correspondre à un muon à partir des propriétés des éléments du \PF\ ayant servi à sa reconstruction, exposée dans le chapitre~\ifref{chapter-LHC}{\ref{chapter-LHC}}{3}.
...
Ces désintégrations sont accompagnées de jets, comme exposé dans le chapitre~\ifref{chapter-JERC}{\ref{chapter-JERC}}{4}.
