...
Ces facteurs sont déterminés par le \POG\ tau à partir d'événements Drell-Yann dans le canal \mu\tauh.
...
Un facteur d'échelle à appliquer aux simulations est fournit par le \POG\ tau en fonction de la pseudorapidité et du DM du \ftauh.
...
À l'instar des muons, un autres facteur d'échelle à appliquer aux simulations est fournit par le \POG\ tau en fonction de la pseudorapidité et du DM du \ftauh.
