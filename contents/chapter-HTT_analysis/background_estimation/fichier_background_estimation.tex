...
Les bruits de fond principaux sont les processus Drell-Yann, \ttbar, \Wjets, QCD, Diboson, \emph{Single-top} et production électrofaible de bosons \Wboson\ et \Zboson\ (EWK).
...
Afin d'estimer les contributions de ces bruits de fond, plusieurs techniques sont utilisées.
\begin{figure}[h]
\centering
...
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/BG/fgraph-DY_small.tex}\vspace{\baselineskip}}
\hfill
...
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/BG/fgraph-WJ_small.tex}\vspace{\baselineskip}}
\hfill
\subcaptionbox{QCD.\label{subfig-chapter-HTT_analysis-section-bg_estimation-procs-QCD}}[.45\textwidth]
{\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/BG/fgraph-QCD_small.tex}\vspace{\baselineskip}}
...
Les événements $\Zboson\to\tau\tau$ sont ainsi couverts par cette méthode mais également une partie des bruits de fond \ttbar, Diboson et EWK.
...
Le FSR est introduit au chapitre~\ifref{chapter-JERC}{\ref{chapter-JERC}}{4}.
Les remplacements des événements simulés se font ainsi sur la base des valeurs de \inlinecode{python}{gen_match}, donnés dans le tableau~\ref{tab-chapter-HTT_analysis-gen_match_values}, pour $L_1$ et $L_2$, définis dans le tableau~\ref{tab-chapter-HTT_analysis-section-offline_selection-L1L2}, selon les coupures données dans le tableau~\ref{tab-chapter-HTT_analysis-gen_match_cuts}.
\begin{table}[h]
\centering
\begin{tabular}{ccl}
\toprule
...
\begin{tabular}{cccl}
\toprule
Canal & \inlinecode{python}{gen_match_1} & \inlinecode{python}{gen_match_2} & Simulations remplacées par la méthode \\
\midrule
...
\input{\PhDthesisdir/contents/chapter-HTT_analysis/background_estimation/MC/fichier_MC.tex}
\input{\PhDthesisdir/contents/chapter-HTT_analysis/background_estimation/embedding/fichier_embedding.tex}
\input{\PhDthesisdir/contents/chapter-HTT_analysis/background_estimation/fake_factors/fichier_fake_factors.tex}
\input{/home/torterotot/Documents/PhD-Thesis/contents/chapter-HTT_analysis/background_estimation/QCD-SS/fichier_QCD-SS.tex}