...
En effet, ce derniers peuvent donner des états finaux similaires à ceux attendus avec le signal recherché, comme illustré sur la figure~\ref{fig-chapter-HTT_analysis-section-bg_estimation-procs}.
\begin{figure}[b]
\centering
...
\subcaptionbox{Drell-Yan $\quark\antiquark\to\Zboson\to\tau\tau\to\mu\tauh$.\label{subfig-chapter-HTT_analysis-section-bg_estimation-procs-DY}}[.45\textwidth]
...
Les particules telles que \inlinecode{python}{IsPrompt == True} proviennent directement de l'événement dur
et
celles avec \inlinecode{python}{IsDirectPromptTauDecayProduct == True} sont issues de la désintégration d'un lepton~\tau\ lui-même vérifiant \inlinecode{python}{IsPrompt == True}.}
