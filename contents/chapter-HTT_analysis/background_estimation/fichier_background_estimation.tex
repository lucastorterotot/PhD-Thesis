...
Enfin, les événements contenant au moins un jet identifié à tort comme provenant d'un lepton~\tau\ est décrit par la méthode des facteurs de faux (\emph{Fake Factors}) décrite section~\ref{chapter-HTT_analysis-section-bg_estimation-FF_method}.
