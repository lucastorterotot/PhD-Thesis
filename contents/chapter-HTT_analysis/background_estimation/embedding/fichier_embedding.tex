...
\draw (\EmbedPictsWidth, \EmbedPictsWidth) node (t) [below left] {\EmbedPictsTxtSize 1};
\draw (t) circle (5.5pt);
...
\draw (2*\EmbedPictsWidth+\EmbedPictsMarginX, \EmbedPictsWidth) node (t) [below left] {\EmbedPictsTxtSize 2};
\draw (t) circle (5.5pt);
...
\draw (2*\EmbedPictsWidth+\EmbedPictsMarginX,-\EmbedPictsMarginY) node (t) [below left] {\EmbedPictsTxtSize 3};
\draw (t) circle (5.5pt);
...
\draw (3*\EmbedPictsWidth+2*\EmbedPictsMarginX,\EmbedPictsWidth/2-\EmbedPictsMarginY/2) node (t) [below left] {\EmbedPictsTxtSize 4};
\draw (t) circle (5.5pt);
...
\subcaptionbox{Sans encapsulation.}[.475\textwidth]
{\plotHTTcontrol{2018}{fully_classic}{mt}{puppimet}}
\hfill
\subcaptionbox{Avec encapsulation.}[.475\textwidth]
