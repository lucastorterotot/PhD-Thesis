...
\bottomrule
\end{tabular}
\caption[Tableaux contenant les informations des chemins de déclenchement.]{Tableaux contenant les informations des chemins de déclenchement pour chaque année et canal de l'analyse.}
