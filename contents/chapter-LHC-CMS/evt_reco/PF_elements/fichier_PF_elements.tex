...
Un détecteur de traces par combinaison basé sur un filtre de Kalman (KF) reconstruit les traces selon la procédure suivante:
\begin{enumerate}
...
Cependant, à cause de l'épaisseur du trajectographe, les électrons émettent avant de parvenir au ECAL une fraction non négligeable de leur énergie par \emph{bremsstrahlung}, \ie\ sous forme de photons.
...
Les traces correspondant à cette situation sur sélectionnées à partir du nombre de points de passage associés et du $\chi^2$ de l'ajustement.
