...
\item $I_{CH}^\text{rel}$ l'isolation relative vis-à-vis des hadrons chargés;
\item $I_{NH}^\text{rel}$ l'isolation relative vis-à-vis des hadrons neutres;
\item $I_{\photon}^\text{rel}$ l'isolation relative vis-à-vis des photons.
\end{itemize}
