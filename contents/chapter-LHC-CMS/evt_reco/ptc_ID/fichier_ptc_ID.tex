...
La formation des jets ainsi que l'hadronisation sont détaillées dans la section~\ifref{chapter-JERC-section-jets}{\ref{chapter-JERC-section-jets}}{2} du chapitre~\ifref{chapter-JERC}{\ref{chapter-JERC}}{4}.
