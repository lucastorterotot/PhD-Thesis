...
Les traces identifiées comme celles de conversions de photons et les dépôts du ECAL associés sont de plus regroupées au candidat initial.
...
Les muons, électrons et photons isolés ayant été reconstruits, seuls les hadrons et les photons non isolés issus de la formation des jets et de l'hadronisation\footnote{La formation des jets ainsi que l'hadronisation sont détaillées~\ifref{chapter-JERC-section-jets}{\ref{chapter-JERC-section-jets-subsec-hadronisation}}{2} du chapitre\ifref{chapter-JERC}{~\ref{chapter-JERC}}{ \og Calibration en énergie des jets \fg{}}.} restent à être reconstruits.
Ces particules sont généralement détectées comme des hadrons chargés (\pionpm, \Kaonpm, protons), de hadrons neutres (\Kaonlong, neutrons), des photons non isolés (désintégration de \pionnull) et plus rarement comme des muons (désintégration de hadrons lourds\footnote{La phénoménologie de la désintégration des hadrons lourds est abordée dans la section~\ifref{chapter-JERC-section-jets}{\ref{chapter-JERC-section-jets-subsec-hadronisation}}{2} du chapitre\ifref{chapter-JERC}{~\ref{chapter-JERC}}{ \og Calibration en énergie des jets \fg{}}.}).
