...
C'est en particulier le cas lors de la calibration en énergie des jets, ce qui est abordé dans la section~\ifref{chapter-JERC-section-CMS}{\ref{chapter-JERC-section-CMS}}{4} du chapitre~\ifref{chapter-JERC}{\ref{chapter-JERC}}{4}.
