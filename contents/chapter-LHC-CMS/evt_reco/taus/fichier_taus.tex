...
\par
%a ce stade, on ne parle plus de depots d'energie dans le ECAL mais de photons. 
%Apres le PF, on ne parle plus que de particules. 
%Ces photons peuvent provenir soit des pi0 directement, soit indirectement : pi0 -> gamma -> e+e- -> photons. 
%cf PF paper
...
\par
Les efficacités d'identification de chacun des points de fonctionnement existants sont données dans le tableau~\ref{tab-JERC-section-taus-DEEPTAU_eff}.
