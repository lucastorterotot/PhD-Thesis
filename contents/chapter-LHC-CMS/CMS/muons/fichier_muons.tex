...
Les autres types de particules ayant été absorbés dans les couches précédentes, seuls les muons atteignent cette partie du détecteur.
...
Deux groupes de quatre chambres mesurent la position du muon dans le plan transverse et sont séparés autant que possible afin d'obtenir la meilleure résolution angulaire.
...
Les modalités du rejet ou de l'enregistrement d'un événement sont discutées plus en détail dans la section~\ref{chapter-LHC-section-CMS-subsec-data_taking}.
