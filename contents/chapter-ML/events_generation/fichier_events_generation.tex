...
Environ 3 millions d'événements ont été sélectionnés selon les critères présentés précédemment parmi plus de 22 millions générés.
...
\begin{figure}[h]
\centering
{\def\Higgs{\higgsML}\input{\PhDthesisdir/plots_and_images/Feynman_diagrams/BG/fgraph-H-tautau_mutau_small.tex}\vspace{\baselineskip}}
