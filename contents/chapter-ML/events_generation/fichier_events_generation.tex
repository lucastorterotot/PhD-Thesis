...
\subsection{Cible et variables d'entrée des modèles}
...
\begin{equation}
\mTtot = \sqrt{\mT^{(L_1,\MET)} + \mT^{(L_2,\MET)} + \mT^{(L_1,L_2)}}
\mend[;]
\end{equation}
...
\item l'activité hadronique additionnelle, définie par une somme des impulsions des jets autres que les deux principaux:\\
