...
Ceci est dû aux processus physiques tels que les \ftauhs\ ne correspondant pas à une résonance se désintégrant en paire de leptons tau
...
Des performances en termes de résolution similaires voir meilleurs que celles de \SVFIT\ sont donc envisageables avec des réseaux de neurones.
\par
Le temps nécessaire pour obtenir les prédictions de notre modèle est 60 fois plus court qu'avec \SVFIT.
Les futures analyses de la collaboration CMS utiliseront de plus grandes quantité d'événements,
...
l'analyse des événements avec une paire de leptons tau dans le cadre du NMSSM (\emph{Next to MSSM}),
...
et l'autre en paire de leptons tau,
est déjà étudiée.
