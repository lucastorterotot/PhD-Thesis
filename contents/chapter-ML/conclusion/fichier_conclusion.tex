...
À partir d'événements que nous avons nous-mêmes simulés à l'aide de \FASTSIM,
l'empilement a été pris en compte et le détecteur modélisé plus précisément.
\par
...
d'après les métriques d'évaluation que nous avons utilisées,
...
Ainsi, l'empilement doit être pris en compte lors de l'entraînement afin d'obtenir un modèle pertinent pour les analyses.
\par
