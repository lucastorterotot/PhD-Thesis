...
À haute masse, la réponse du modèle B est toutefois plus proche de 1.
...
La réponse de B est toutefois plus proche de 1 que celle de \Bchsplit{et} sur toute la gamme de masse.
\par
...
En revanche, à basse masse, le modèle B a une réponse de \num{1.06} contre \num{1.10} pour \Bchsplit{lt}.
\begin{figure}[h]
\centering
