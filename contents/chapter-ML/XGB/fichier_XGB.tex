...
ou à une réponse finale sur une \og feuille \fg{} (en rouge et vert).
\begin{figure}[h]
\centering\small
\begin{tikzpicture}
\def\DeltaX{1.5}
...
\end{equation}
avec
$S_{b_1+b_2}$ la similarité du jeu de données non séparé,
$S_{b_1}$ ($S_{b_2}$) la similarité du jeu de données se retrouvant dans la branche $b_1$ ($b_2$).
