...
\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolorblue1] (C) at (-1.5*\DeltaX,-1*\DeltaY) {lien ou pièce jointe};

\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolorgreen1] (Ca) at (-2.25*\DeltaX,-2*\DeltaY) {mail accepté};

\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolorblue1] (D) at (0*\DeltaX,-2*\DeltaY) {orthographe douteuse};

\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolorred1] (Dr) at (1.5*\DeltaX,-3*\DeltaY) {pourriel};

\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolorblue1] (E) at (-1*\DeltaX,-3*\DeltaY) {expéditeur connu};

\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolororange1] (F) at (-2*\DeltaX,-4*\DeltaY) {méfiance!};

\node [draw, thick, rectangle, rounded corners = 5pt, fill = ltcolorgreen1] (G) at (0*\DeltaX,-4*\DeltaY) {mail accepté};

\draw [thick, -latex, ltcolorred] (A) to (C) ;
%\draw [thick, -latex, ltcolorred] (B) to (Br) ;
\draw [thick, -latex, ltcolorred] (C) to (Ca) ;
\draw [thick, -latex, ltcolorred] (D) to (E) ;
\draw [thick, -latex, ltcolorred] (E) to (F) ;

\draw [thick, -latex, ltcolorgreen] (A) to (B) ;
%\draw [thick, -latex, ltcolorgreen] (B) to (E) ;
\draw [thick, -latex, ltcolorgreen] (C) to (D) ;
\draw [thick, -latex, ltcolorgreen] (D) to (Dr) ;
...
\end{tikzpicture}
\caption[Exemple d'un arbre de décision.]{Exemple d'un arbre de décision classant des mails comme pourriel (\emph{spam}) ou potentiellement dangereux.}
