...
Ces zones sont déterminées de manière indépendante sur les valeurs inférieures et supérieures à la médiane,
...
\item moyenne masse : $\SI{150}{\GeV} \leq m_{\higgsML} < \SI{500}{\GeV}$;
...
Elles sont de plus facilement obtenues à partir du dilepton, défini chapitre~\refChHTT, et de \MET.
...
et
en figure~\ref{subfig-DNN_vs_XGB-low_1sigma} à basse masse.
