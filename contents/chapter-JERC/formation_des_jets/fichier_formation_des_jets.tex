...
{\input{\PhDthesisdir/tex/Feynman_diagrams/gerbe_partonique/fgraph-Z_q_q.tex}\vspace{\baselineskip}}
\hfill
\subcaptionbox{\label{subfig-fgraph-Z_qg_q}}[.3\textwidth]
{\input{\PhDthesisdir/tex/Feynman_diagrams/gerbe_partonique/fgraph-Z_qg_q.tex}\vspace{\baselineskip}}
\hfill
...
{\begin{tikzpicture}
\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/partonic_shower_tikz/qq.tex}
\end{tikzpicture}}
\hfill
...
{\begin{tikzpicture}
\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/partonic_shower_tikz/qq.tex}
\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/partonic_shower_tikz/qqg.tex}
\end{tikzpicture}}
\hfill
...
\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/partonic_shower_tikz/qq.tex}
\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/partonic_shower_tikz/qqg.tex}
\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/partonic_shower_tikz/qqNg.tex}
\end{tikzpicture}}
...
Dans le chapitre~\ifref{chapter-MS-MSSM}{\ref{chapter-MS-MSSM}}{sur le modèle standard}, nous avons vu que $g_s$ augmente lorsque l'échelle d'énergie diminue. 
...
{\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/Lund_tikz/Lund_1.tex}}
\hfill
\subcaptionbox{Une \og corde \fg{} de flux de couleur se forme entre les deux quarks.\label{subfig-Lund2}}[.3\textwidth]
{\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/Lund_tikz/Lund_2.tex}}
\hfill
...
{\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/Lund_tikz/Lund_3.tex}}

\vspace{\baselineskip}

\subcaptionbox{Le processus se répète tant qu'il y a suffisamment d'énergie pour générer une paire de quarks.\label{subfig-Lund4}}[.4\textwidth]
{\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/Lund_tikz/Lund_4.tex}}
\qquad\qquad
\subcaptionbox{Des hadrons non colorés sont formés se forment à partir des quarks de basse énergie.\label{subfig-Lund5}}[.4\textwidth]
{\input{\PhDthesisdir/contents/chapter-JERC/formation_des_jets/Lund_tikz/Lund_5.tex}}
...
\centering
\input{\PhDthesisdir/tex/Feynman_diagrams/QCD/fgraph-QCD_clustering_fragmentation.tex}
