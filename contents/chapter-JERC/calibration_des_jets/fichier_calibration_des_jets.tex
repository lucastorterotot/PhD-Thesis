...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/response_evolution_1.png}}
\hfill
\subcaptionbox{Correction de l'empilement.\label{subfig-JERC_RunI-1_2}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/response_evolution_2.png}}
\hfill
\subcaptionbox{Après correction ($R_\cali$).\label{subfig-JERC_RunI-1_3}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/response_evolution_3.png}}
...
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/Figure_005-a.tex}}
\hfill
\subcaptionbox{Après correction.\label{subfig-chapter-JERC-section-CMS-subsec-PU-JERC_RunI-Figure_005b}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/Figure_005-b.tex}}
...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/simulated_jet_response_2016.png}}
\hfill
\subcaptionbox{Année 2017.\label{subfig-simulated_jet_response_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/simulated_jet_response_2017.png}}
\hfill
\subcaptionbox{Année 2018.\label{subfig-simulated_jet_response_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/simulated_jet_response_2018.png}}
...
\begin{figure}[h]
\centering
\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/relative_eta_residual_RunII.png}
...
\item événements multijets: ces événements contiennent au moins deux jets dans l'état final et couvrent la région $\pT>\SI{800}{\GeV}$\footnote{Les événements multijets sont uniquement utilisés en 2016. En 2017 et 2018, la région $\pT>\SI{800}{\GeV}$ est couverte par les événements \Gjets.}.
\end{itemize}
...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/absolute_pT_residual_2016.png}}
\hfill
\subcaptionbox{Année 2017.\label{subfig-absolute_pT_residual_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/absolute_pT_residual_2017.png}}
\hfill
\subcaptionbox{Année 2018.\label{subfig-absolute_pT_residual_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/absolute_pT_residual_2018.png}}
...
\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/Figure_030-a.png}
...
\begin{figure}[h]
\centering
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2016.\label{subfig-Syst_uncs_pT_2016}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_pT_2016.png}}
\hfill
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2017.\label{subfig-Syst_uncs_pT_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_pT_2017.png}}
\hfill
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2018.\label{subfig-Syst_uncs_pT_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_pT_2018.png}}

\vspace{\baselineskip}

\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2016.\label{subfig-Syst_uncs_eta_2016}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_eta_2016.png}}
\hfill
\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2017.\label{subfig-Syst_uncs_eta_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_eta_2017.png}}
\hfill
\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2018.\label{subfig-Syst_uncs_eta_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_eta_2018.png}}
...
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/Figure_036-b.png}}
\hfill
...
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/JER_SF_RunII.png}}
