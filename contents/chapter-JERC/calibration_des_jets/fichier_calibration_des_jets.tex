...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/response_evolution_1.png}}
\hfill
\subcaptionbox{Correction de l'empilement.\label{subfig-JERC_RunI-1_2}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/response_evolution_2.png}}
\hfill
\subcaptionbox{Après correction ($R_\cali$).\label{subfig-JERC_RunI-1_3}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/response_evolution_3.png}}
...
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/Figure_005-a.tex}}
\hfill
\subcaptionbox{Après correction.\label{subfig-chapter-JERC-section-CMS-subsec-PU-JERC_RunI-Figure_005b}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/Figure_005-b.tex}}
...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/simulated_jet_response_2016.png}}
\hfill
\subcaptionbox{Année 2017.\label{subfig-simulated_jet_response_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/simulated_jet_response_2017.png}}
\hfill
\subcaptionbox{Année 2018.\label{subfig-simulated_jet_response_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/simulated_jet_response_2018.png}}
...
\begin{figure}[h]
\centering
\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/relative_eta_residual_RunII.png}
...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/absolute_pT_residual_2016.png}}
\hfill
\subcaptionbox{Année 2017.\label{subfig-absolute_pT_residual_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/absolute_pT_residual_2017.png}}
\hfill
\subcaptionbox{Année 2018.\label{subfig-absolute_pT_residual_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/absolute_pT_residual_2018.png}}
\caption[Correction résiduelle absolue en $\pT$ pour $\abs{\eta}<\num{1.3}$ lors du Run~II.]{Correction résiduelle absolue en $\pT$ pour $\abs{\eta}<\num{1.3}$ lors du Run~II obtenue par ajustement global sur les événements \Gjets, \Zjets\ et multijets~\cite{CMS-DP-2020-019}. Les événements multijets sont uniquement utilisés en 2016, 2016-UL, 2017-UL et 2018-UL. En 2017 et 2018, la région $\pT>\SI{800}{\GeV}$ est couverte par les événements \Gjets.}
%Mikko:
%We are now using multijets again, thanks to getting it back to Helsinki, reverting back closer to Run 1 method and actually pushing hard to understand and reduce the systematic uncertainties. And it’s working wonderfully! We’re for sure going to use multijets for all UL samples. Now is the first time it’s actually more constraining at high pT than gamma+jet.
...
\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/Figure_030-a.png}
...
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/Syst_uncs_pT_2016.png}}
\hfill
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2017.\label{subfig-Syst_uncs_pT_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/Syst_uncs_pT_2017.png}}
\hfill
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2018.\label{subfig-Syst_uncs_pT_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/Syst_uncs_pT_2018.png}}

\vspace{\baselineskip}

\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2016.\label{subfig-Syst_uncs_eta_2016}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/Syst_uncs_eta_2016.png}}
\hfill
\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2017.\label{subfig-Syst_uncs_eta_2017}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/Syst_uncs_eta_2017.png}}
\hfill
\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2018.\label{subfig-Syst_uncs_eta_2018}}[.3\textwidth]
{\includegraphics[width=.3\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_CMS-DP-2020-019/Syst_uncs_eta_2018.png}}
...
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/img_from_JERC_RunI/Figure_036-b.png}}
\hfill
