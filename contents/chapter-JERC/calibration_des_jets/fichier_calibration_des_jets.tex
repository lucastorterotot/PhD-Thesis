...
\mend[,]
\end{equation}
où \vMET\ est l'impulsion transverse manquante (MET) définie dans la section~\ifref{chapter-LHC-section-evt_reco-subsec-MET}{\ref{chapter-LHC-section-evt_reco-subsec-MET}}{4.4} du chapitre~\ifref{chapter-LHC}{\ref{chapter-LHC}}{3}.
...
\par En appliquant~\eqref{eq-chapter-JERC-section-CMS-subsec-residuals-pT_ref_approx_ptcl_reco} à l'équation précédente, il est possible d'écrire
\begin{equation}
