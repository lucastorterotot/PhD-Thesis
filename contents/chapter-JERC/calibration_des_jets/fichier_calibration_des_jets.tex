...
\begin{figure}[h]
\centering
\subcaptionbox{Avant correction ($R_\reco$).\label{subfig-JERC_RunI-1_1}}[.31\textwidth]
...
\hfill
\subcaptionbox{Après correction ($R_\cali$).\label{subfig-JERC_RunI-1_3}}[.31\textwidth]
...
avec les réglages Z2*~\cite{Khachatryan:2015pea}
sur des événements simulés dijet, \Zjet\ et \Gjet,
