...
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/simulated_jet_response_2016.png}}
\hfill
\subcaptionbox{Année 2017.\label{subfig-simulated_jet_response_2017}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/simulated_jet_response_2017.png}}
\hfill
\subcaptionbox{Année 2018.\label{subfig-simulated_jet_response_2018}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/simulated_jet_response_2018.png}}
...
définies dans la section~\ifref{chapter-LHC-section-evt_reco-subsec-MET}{\ref{chapter-LHC-section-evt_reco-subsec-MET}}{4.4} du chapitre\ifref{chapter-LHC}{~\ref{chapter-LHC}}{ \og Dispositif expérimental \fg},
...
\par La JES est ainsi propagée à \vMET\ par la correction dite de \og type-I \fg,
\begin{equation}
...
\mend
\end{equation}
\par Le principe est d'estimer la réponse du jet en s'appuyant sur un objet de référence pouvant être un boson \Zboson\ (événements \Zjets), un photon (événements \Gjets) ou un autre jet (événements dijets et multijets).
...
\end{equation}
car l'objet de référence, fidèlement reconstruit, permet de considérer $\vpT_\reco^\text{réf}=\vpT_\ptcl^\text{réf}=\vpT^\text{réf}$.\\
...
\Leftrightarrow
\vpT_\ptcl^\text{réf} + \RMPF\vpT_\ptcl^\text{recul} = -\vMET
\mend[,]
\end{equation}
définissant ainsi la réponse MPF \RMPF\ comme
\begin{equation}
...
\begin{figure}[h]
\centering
\includegraphics[width=.4\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/relative_eta_residual_RunII.png}
...
\end{itemize}
\par L'objet de référence utilisé pour calibrer le jet, que ce soit un boson \Zboson\ (\Zjets), un photon (\Gjets) ou un autre jet (multijets), possède une meilleure résolution en énergie.
...
\begin{figure}[h]
\centering
\subcaptionbox{Année 2016.\label{subfig-absolute_pT_residual_2016}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/absolute_pT_residual_2016.png}}
\hfill
\subcaptionbox{Année 2017.\label{subfig-absolute_pT_residual_2017}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/absolute_pT_residual_2017.png}}
\hfill
\subcaptionbox{Année 2018.\label{subfig-absolute_pT_residual_2018}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/absolute_pT_residual_2018.png}}
\caption[Correction résiduelle absolue en $\pT$ pour $\abs{\eta}<\num{1.3}$ lors du Run~II.]{Correction résiduelle absolue en $\pT$ pour $\abs{\eta}<\num{1.3}$ lors du Run~II obtenue par ajustement global sur les événements \Gjets, \Zjets\ et multijets~\cite{CMS-DP-2020-019}.}
...
avec les réglages Z2*~\cite{Khachatryan:2015pea}
sur des événements simulés dijet, \Zjets\ et \Gjets,
est représentée sur la figure~\ref{fig-chapter-JERC-section-CMS-subsec-PU-JERC_RunI-Figure_030a}.
Des corrections allant jusqu'à \SI{4}{\%} sont appliquées.
\begin{figure}[h]
\centering
\includegraphics[width=.4\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/Figure_030-a.png}
...
Cette incertitude correspond aux écarts observés entre les méthodes utilisant les réponses~\Rbal\ et~\RMPF\ d'une part et entre les analyses utilisant les jeux de données \Zjets, \Gjets\ et dijets d'autre part.
...
\begin{figure}[h]
\centering
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2016.\label{subfig-Syst_uncs_pT_2016}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_pT_2016.png}}
\hfill
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2017.\label{subfig-Syst_uncs_pT_2017}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_pT_2017.png}}
\hfill
\subcaptionbox{En fonction de $\pT$ pour $\abs{\eta}=0$ en 2018.\label{subfig-Syst_uncs_pT_2018}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_pT_2018.png}}

\vspace{\baselineskip}

\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2016.\label{subfig-Syst_uncs_eta_2016}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_eta_2016.png}}
\hfill
\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2017.\label{subfig-Syst_uncs_eta_2017}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_eta_2017.png}}
\hfill
\subcaptionbox{En fonction de $\eta$ pour $\pT=\SI{30}{\GeV}$ en 2018.\label{subfig-Syst_uncs_eta_2018}}[.31\textwidth]
{\includegraphics[width=.31\textwidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/Syst_uncs_eta_2018.png}}
...
\begin{figure}[h]
\centering
\subcaptionbox{JER en fonction de \pT\ dans le barillet de CMS ($\abs{\eta}<\unm{1.3}$) pour différentes valeurs d'interactions d'empilement $\mu$ lors du Run~I~\cite{JERC_RunI}.\label{subfig-chapter-JERC-section-CMS-subsec-JER-JERC_RunI-Figure_036-b}}[.4\textwidth]
{\includegraphics[width=8cm]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_JERC_RunI/Figure_036-b.png}}
\hfill
\subcaptionbox{Facteurs d'échelle de la résolution en énergie des jets en fonction de $\eta$ lors du Run~II~\cite{CMS-DP-2020-019}.\label{subfig-chapter-JERC-section-CMS-subsec-JER-JER_SF_RunII}}[.4\textwidth]
{\includegraphics[width=\linewidth]{\PhDthesisdir/contents/chapter-JERC/calibration_des_jets/img_from_CMS-DP-2020-019/JER_SF_RunII.png}}
