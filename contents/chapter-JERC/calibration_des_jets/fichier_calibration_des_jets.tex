...
\caption[Correction résiduelle absolue en $\pT$ pour $\abs{\eta}<\num{1.3}$ lors du Run~II.]{Correction résiduelle absolue en $\pT$ pour $\abs{\eta}<\num{1.3}$ lors du Run~II obtenue par ajustement global sur les événements \Gjets, \Zjets\ et multijets~\cite{CMS-DP-2020-019}. Les événements multijets sont uniquement utilisés en 2016. En 2017 et 2018, la région $\pT>\SI{800}{\GeV}$ est couverte par les événements \Gjets.}
