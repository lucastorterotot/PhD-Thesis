\section{Étapes de la calibration}\label{chapter-JERC-section-CMS}
...
\end{equation}
Au niveau reconstruit, l'énergie transverse manquante (MET), introduite dans le chapitre~\refChLHCCMS, doit être prise en compte dans le recul.
...
\end{wrapfigure}
Les propriétés des jets dépendent de leur saveur, \ie\ du parton initial, comme exposé au chapitre~\refChMSSM.
Il existe ainsi une différence de réponse selon la saveur du jet, majoritairement due à la fragmentation en énergie et la composition du jet qui dépendent de cette saveur~\cite{JERC_RunI}.
