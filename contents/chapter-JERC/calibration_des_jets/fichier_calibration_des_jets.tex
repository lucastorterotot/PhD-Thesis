...
De 2017 à 2018, les photodiodes des bouchons du HCAL sont remplacées par des photomultiplicateurs à silicium~\cite{CMS-TDR-10,SiPM_CMS_conf}.
...
\end{equation}
Au niveau reconstruit, l'impulsion transverse manquante (MET) définie dans le chapitre~\refChLHCCMS\ doit être prise en compte dans le recul.
...
Pour $\abs{\eta}\in[\num{2.5}\isp\num{3.0}]$, cette incertitude est bien plus importante en 2017 que pour les autres années. Il s'agit de la région de transition entre les bouchons du HCAL (HE) et le HCAL avancé (HF), \ie\ deux parties distinctes du détecteur.
