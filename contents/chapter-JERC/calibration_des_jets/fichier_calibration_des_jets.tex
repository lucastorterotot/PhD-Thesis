...
Pour $\abs{\eta}\simeq\num{2.5}$, cette incertitude est bien plus importante en 2017 que pour les autres années. Il s'agit de la région de transition entre les bouchons du HCAL (HE) et le HCAL avancé (HF), \ie\ deux parties distinctes du détecteur.
