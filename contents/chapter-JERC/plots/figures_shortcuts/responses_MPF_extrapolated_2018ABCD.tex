...
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/used/only_L2Res/Run2018ABCD/extrapolated/response_eta0013_mpf_extrap.pdf}}
\hfill
\subcaptionbox{$\num{1.3} \leq \abs{\eta^\text{jet}} < \num{2.0}$.\label{subfig-response_eta1319_MPF_extrapolated_2018ABCD}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/used/only_L2Res/Run2018ABCD/extrapolated/response_eta1319_mpf_extrap.pdf}}

\vfill

\subcaptionbox{$\num{2.0} \leq \abs{\eta^\text{jet}} < \num{2.5}$.\label{subfig-response_eta1925_MPF_extrapolated_2018ABCD}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/used/only_L2Res/Run2018ABCD/extrapolated/response_eta1925_mpf_extrap.pdf}}
\hfill
\subcaptionbox{$\num{2.5} \leq \abs{\eta^\text{jet}} < \num{3.0}$.\label{subfig-response_eta2530_MPF_extrapolated_2018ABCD}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/used/only_L2Res/Run2018ABCD/extrapolated/response_eta2530_mpf_extrap.pdf}}
