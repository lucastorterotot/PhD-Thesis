...
\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=8cm]{\PhDthesisdir/contents/chapter-JERC/plots/my_plots/distributions/2018/source/ptFirstJet_log.pdf}};
...
\draw (1.3, {3.61+(\pos-1)/(6-1)*(9.125-3.61)}) node [left] {\small $\val$};
}
