\section{Phénoménologie des événements \Gjet}\label{chapter-JERC-section-pheno-GJets}
...
\caption{Résolution relative en énergie des photons en fonction de $\eta$ pour des événements simulés $\higgs\to\photon\photon$~\cite{photon_ID_2015}. La variable $R_9$ est définie dans la section~\todo{???}.}
...
\end{figure}
\subsection{Effets radiatifs et activité additionnelle}
...
Dans le cas du diagramme de la figure~\ref{subfig-fgraph-gq_qGamma_S-FSR_2jets}, correspondant à un jet additionnel par FSR, le photon est balancé avec le \par système des deux jets. La topologie d'un tel événement est illustrée sur la figure~\ref{subfig-Gamma_plus_two_jets}.
...
\begin{figure}[h]
\centering
\subcaptionbox{Réponse balancée.\label{subfig-response_eta0013_ptPhot_175_230}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/used/only_L2Res/Run2018ABCD/extrapolation/response_eta0013_ptPhot_175_230.pdf}}
\qquad
\subcaptionbox{Réponse MPF.\label{subfig-responseMPF_eta0013_ptPhot_175_230}}[.45\textwidth]
{\includegraphics[width=.45\textwidth]{\PhDthesisdir/contents/chapter-JERC/plots/used/only_L2Res/Run2018ABCD/extrapolation/responseMPF_eta0013_ptPhot_175_230.pdf}}
