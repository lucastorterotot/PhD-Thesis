...
\caption{Densités de probabilité du nombre d'interactions d'empilement pour les périodes de prises de données de 2018.}
...
\caption{Densités de probabilité du nombre d'interactions d'empilement pour les périodes de prises de données de 2017-UL.}
