...
\bottomrule
\end{tabular}
\caption{Intervalles de $\pT^{\photon}$ en \SI{}{\GeV}.}
\label{tab-pT_photon_intervalles}
\end{table}
\par La calibration en énergie des jets dépend fortement de la région du détecteur dans lequel il laisse un signal, comme le montre la figure~\ref{fig-simulated_jet_response_RunII} en page~\pageref{fig-simulated_jet_response_RunII}.
...
then tell grid pT photon-eta jet, analysis.
Get plots (see Hugues thesis to make sure all relevant are here)
98.5 pct RMS, mean
