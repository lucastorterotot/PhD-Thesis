...
Plusieurs périodes (\emph{runs}) sont considérées pour chacune de ces années, celles des collisions \proton\proton, dont la liste et les luminosités correspondantes sont présentés dans le tableau~\ref{tab-Runs_and_lumis_2018_and_2017UL_GJet}.
