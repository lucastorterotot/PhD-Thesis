...
avec les événements \Gjets\ a été un de mes travaux de thèse.
J'ai ainsi traité les événements des années 2018 et 2017-UL.
...
L'évolution des réponses moyennes en fonction de $\alpha$ y étant linéaire, ce choix rend possible une extrapolation simple vers $\alpha=0$.
\begin{table}[h]
\centering
\begin{tabular}{ccccc}
\toprule
