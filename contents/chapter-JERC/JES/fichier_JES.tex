...
Comme expliqué dans la section~\ifref{chapter-LHC-section-CMS-subsec-data_taking}{\ref{chapter-LHC-section-CMS-subsec-data_taking}}{4.7} du chapitre~\ifref{chapter-LHC}{\ref{chapter-LHC}}{3}, un événement observé par le détecteur CMS est sauvegardé si un chemin de déclenchement (HLT \emph{path}) est activé.
