...
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-JERC/reconstruction_des_jets/JetIDs/2016.tex}
...
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-JERC/reconstruction_des_jets/JetIDs/2017.tex}
...
\begin{table}[p]
\centering
\input{\PhDthesisdir/contents/chapter-JERC/reconstruction_des_jets/JetIDs/2017UL.tex}
...
\par Les gluons portent une charge de couleur plus importante que les quarks\footnote{Les quarks portent une couleur, les antiquarks une anticouleur et les gluons portent une couleur et une anticouleur.}. Il en résulte des jets moins collimés qu'avec des quarks.
\par Le quark top possède un temps de vie trop court pour participer à l'hadronisation. Il se désintègre alors par interaction faible en un autre quark, très majoritairement un quark \quarkb, et un boson \Wboson. Le nouveau quark issu de cette désintégration forme alors un jet.
\par Les quarks \quarkd, \quarku, \quarks, \quarkc\ et \quarkb\ participent à l'hadronisation et se retrouvent confinés au sein des hadrons ainsi formés.
Or, les hadrons contenant des quarks de deuxième (\quarks, \quarkc) ou troisième génération (\quarkb) ne sont pas stables et se désintègrent par interaction faible.
\par Les quarks \quarkb\ contenus dans les hadrons peuvent se désintégrer en quark \quarkc\ ou \quarku\ selon
\begin{equation}
...
Des hadrons contenant un quark \quarkb\ ont ainsi une durée de vie $\tau$ de l'ordre de la picoseconde~\cite{B0s_lifetime,lifetimes_c_b_hadrons} et peuvent voyager sur une distance de l'ordre de
\begin{equation}
d_{\quarkb} = \gamma \,\beta c\, \tau = \frac{\beta c \, \tau}{\sqrt{1-\beta^2}} \simeq \SI{1}{\milli\meter}
\mend
\label{eq-chapter-JERC-section-jets_reco-subsec-flavor-fly_B_hadrons}
\end{equation}
...
Le boson \Wboson\ issu du changement de saveur du quark \quarkb\ se désintègre leptoniquement dans \SI{30}{\%} des cas~\cite{PDG_booklet_2018} selon
\begin{equation}
\Wbosonpm \to \ell^\pm \nu_\ell
\mend
\end{equation}
...
\clip (-145:\Solenrin) rectangle (\Bjetangle:2*\Solenrin);
...
\end{figure}
\par Les quarks \quarkc\ suivent le même schéma que les quarks \quarkb. Cependant, leur canal de désintégration principal est
\begin{equation}
...
Des hadrons contenant un quark \quarkc\ ont ainsi une durée de vie $\tau$ de inférieure à la picoseconde~\cite{lifetimes_c_b_hadrons} et il est plus difficile d'identifier les jets issus de quarks \quarkc\ que ceux issus de quarks \quarkb.
\par Les quarks \quarks\ forment des hadrons suffisamment stables pour se propager sur des distances plus importantes, jusqu'à plusieurs mètres pour certains.
Le phénomène décrit précédemment pour les quarks \quarkb\ et \quarkc\ n'est donc pas observable. Enfin, les quarks \quarkd\ et \quarku\ forment des hadrons stables.
...
\subsubsection{Algorithmes d'identification de la saveur des jets}
Les jets présentent ainsi des propriétés caractéristiques, selon qu'il s'agisse:
\begin{itemize}
\item d'un jet léger, issu d'un quark \quarkd, \quarku\ ou \quarks;
\item d'un jet lourd:
\begin{itemize}
\item issu d'un quark \quarkc: traces déplacées et éventuellement un lepton chargé,
\item issu d'un quark \quarkb: même phénomène, encore plus marqué;
\end{itemize}
\item d'un jet issu d'un gluon (\gluon): le jet est moins collimé qu'avec un quark.
\end{itemize}

b-tagging

Il est ainsi possible de d'étiqueter les jets comme étant des jets issus de quarks \quarkb\, \quarkc, de gluons, ou \og légers \fg{} (issus de quarks \quarkd, \quarku, \quarks).


%Cacciari_pu_sub_jet_area_2008
%Sirunyan_heavy_flavor_jets_2018
