...
\caption{Temps de reconstruction d'un empilement d'un événement dijets avec $N$ événements ne produisant que des jets de bas \pT\ pour différents algorithmes de reconstruction des jets.} % 50 GeV
