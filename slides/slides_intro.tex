...
%
%\draw [thick, -latex] (t3.south) --+ (-.75,-1.35) node (l4) [below] {heavier};
%\draw [thick, -latex] (l4.south) --+ (0,-.5) node (l5) [below] {not lighter?};
%
%\draw [thick, -latex] (t2.south) --+ (-1.25,-1) node (l6) [below] {already one!};
...
\draw (\textwidth/2,-.725\textheight) node [above] {+ Part~IV: \color{ltcolorviolet}\textbf{with Machine Learning techniques}};
\draw (.99\textwidth,-.725\textheight) coordinate (a);
\end{tikzpicture}
\end{center}
\end{frame}