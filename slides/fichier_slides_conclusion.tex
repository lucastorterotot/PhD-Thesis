...
\drawCARD{IP2I}{\PhDthesisdir/plots_and_images/logos/logo_IP2I.pdf}{4}{Colin,{Gaël, Ece},Hugues,{Aurélien, Antoine L.},{Jean-François, Grégoire},{Corentin, Martin},autres doctorants,groupe CMS,Antoine C.,personnels}

\draw (bottom) coordinate (CMS);

\draw (right) coordinate (KIT);
\drawCARD{KIT}{\PhDthesisdir/plots_and_images/logos/KIT.png}{4}{{Günter, Roger},Artur,{Sebastian B., Maximilian}, Sebastian W., Janek, Felix}

\draw (bottom) coordinate (IC);
\drawCARD{IC}{\PhDthesisdir/plots_and_images/logos/IC.jpg}{4}{Daniel,David,Georges}

\draw (bottom) coordinate (DESY);
\drawCARD{DESY}{\PhDthesisdir/plots_and_images/logos/DESY.png}{4}{Aleksei,Mareike}

\draw (bottom) coordinate (HEPHY);
\drawCARD{HEPHY}{\PhDthesisdir/plots_and_images/logos/HEPHY-crop.png}{4}{Janik,Suman}

\drawCARD{CMS}{\PhDthesisdir/plots_and_images/logos/CMS_logo.pdf}{4}{équipe des guides,Jacob,Jean,Giuseppe,Juska,Yi,Mikko}
