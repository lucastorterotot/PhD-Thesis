...
\drawCARD{IP2I}{\PhDthesisdir/plots_and_images/logos/logo_IP2I.pdf}{4}{Colin,{Gaël, Ece},Hugues,Aurélien,{Jean-François, Grégoire},autres doctorants,groupe CMS,personnels}

\draw (bottom) coordinate (CMS);

\draw (right) coordinate (KIT);
\drawCARD{KIT}{\PhDthesisdir/plots_and_images/logos/KIT.png}{4}{{Günter, Roger},Artur,Sebastian B., Sebastian W., Maximilian, Felix}
