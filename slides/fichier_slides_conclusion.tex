...
\begin{frame}{Conclusion \& prospects: ML \& particle physics}
\manip Introduced a method to estimate a mass from the (partial) final state ;
\manip Other applications:
\submanip \quarkb-tagging (\textsc{DeepCSV}),
\submanip \tauh\ identification (\textsc{DeepTau}),
\submanip event classification.
\end{frame}
