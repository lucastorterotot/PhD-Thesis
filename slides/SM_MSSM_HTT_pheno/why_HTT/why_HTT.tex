\begin{frame}
\backupslinklabel{htt}
\frametitle{Why \HAtoTauTau?}
...
\frametitle{Why \HAtoTauTau? -- enhanced and suppressed couplings}
\begin{minipage}[c]{.3\textwidth}
\begin{center}
\begin{tikzpicture}
\draw (0,0) node (h) {\Higgs, \HiggsA};
...
\begin{frame}\addtocounter{framenumber}{-1}
\frametitle{Why \HAtoTauTau? -- Higgs couplings and particules masses}
\begin{minipage}[c]{.3\textwidth}
\begin{center}
\begin{tikzpicture}
\draw (0,0) node (h) {\Higgs, \HiggsA};
...
\begin{frame}\addtocounter{framenumber}{-1}
\frametitle{Why \HAtoTauTau? -- avoid hadronic background}
\begin{minipage}[c]{.3\textwidth}
\begin{center}
\begin{tikzpicture}
\draw (0,0) node (h) {\Higgs, \HiggsA};
