...
\begin{center}
\includegraphics[width=\graphw, height=\graphh, keepaspectratio]{\PhDthesisdir/slides/LHC-CMS/CMS/CMS-eta-ranges.png}
\end{center}
\end{frame}
...
\begin{block}{}
\begin{equation*}
\input{\PhDthesisdir/slides/HTT_analysis/isolation_explained/relative_isolation_equation.tex}
\end{equation*}
\begin{center}
