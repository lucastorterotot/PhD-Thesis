...
\node[anchor=south west,inner sep=0] at (0,0) {\frame{\includegraphics[width=\EmbedPictsWidth cm]{\PhDthesisdir/slides/HTT_analysis/embedding_explained/Z_to_mumu_data.png}}};
...
%\node[anchor=south west,inner sep=0] at (\EmbedPictsWidth+\EmbedPictsMargin,0) {\frame{\includegraphics[width=\EmbedPictsWidth cm]{\PhDthesisdir/slides/HTT_analysis/embedding_explained/remove_mumu.png}}};
%
...
%\node[anchor=south west,inner sep=0] at (\EmbedPictsWidth+\EmbedPictsMargin,-\EmbedPictsWidth-\EmbedPictsMargin) {\frame{\includegraphics[width=\EmbedPictsWidth cm]{\PhDthesisdir/slides/HTT_analysis/embedding_explained/Z_to_tautau_simulation.png}}};
%
...
%\node[anchor=south west,inner sep=0] at (2*\EmbedPictsWidth+2*\EmbedPictsMargin,-\EmbedPictsWidth/2-\EmbedPictsMargin/2) {\frame{\includegraphics[width=\EmbedPictsWidth cm]{\PhDthesisdir/slides/HTT_analysis/embedding_explained/embedded_event.png}}};
