...
\submanip $\Zboson\to\ele\ele$ + $\Zboson\to\mu\mu$ in \colorbox{\ZLLcolor}{$\Zboson\to\ell\ell$} ($\ell\to\tauh$)
...
\draw (.025\textwidth, .7\textheight) node [right, text depth=0pt] (A) {\manip \textbf{Lots} of hard work to obtain this:};
...
%
%\begin{tikzpicture}[overlay, remember picture]
%\draw [ltcolorred] (10.5,4) node {Excluded} ;
