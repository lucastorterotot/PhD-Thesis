...
\end{minipage}
\hfill\begin{minipage}[t]{.35\textwidth}
\begin{block}{\tikzmarknode{Solenoid}{start}}
\begin{itemize}
...
\draw (4.5,4.3) coordinate (end);
\draw [ltcolorred, very thick, -latex] (start) to [out=-180, in=45] (end) ;
\end{tikzpicture}
\end{frame}
...
\end{minipage}
\hfill\begin{minipage}[t]{.35\textwidth}
\begin{block}{\tikzmarknode{Tracker}{start}}
\begin{itemize}
...
\end{minipage}
\hfill\begin{minipage}[t]{.35\textwidth}
\begin{block}{\tikzmarknode{Electromagnetic CALorimeter}{start}}
\begin{itemize}
...
\end{minipage}
\hfill\begin{minipage}[t]{.35\textwidth}
\begin{block}{\tikzmarknode{Hadronic CALorimeter}{start}}
\begin{itemize}
...
\end{minipage}
\hfill\begin{minipage}[t]{.35\textwidth}
\begin{block}{\tikzmarknode{Steel return yoke (red)}{start}}
\begin{itemize}
\item Allows for \SI{2}{\tesla} magnetic field around the solenoid
\end{itemize}
\end{block}

\begin{block}{\tikzmarknode{Muon chambers (blue-gray)}{start2}}
\begin{itemize}
...
\begin{tikzpicture}[overlay, remember picture]
\draw (6.1,5.2) coordinate (end);
\draw [ltcolorred, very thick, -latex] (start) to [out=-180, in=45] (end) ;
\draw (7.5,3.5) coordinate (end2);
\draw [ltcolorred, very thick, -latex] (start2) to [out=-180, in=45] (end2) ;
\end{tikzpicture}
\end{frame}
