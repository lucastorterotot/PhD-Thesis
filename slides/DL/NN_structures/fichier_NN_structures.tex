...
\fill[white] (2.83,-2.5) rectangle (5.16,2.5);

\foreach \x/\y in {-.5/-.5,1/-1,2.5/-1,5.5/-1}{
\fill (\x,\y) circle (1pt);
...
\foreach \y in {0,1,2,-2}{
\fill (4,\y) circle (1pt);
\fill (4+.2,\y) circle (1pt);
\fill (4-.2,\y) circle (1pt);
}

\foreach \x in {1.75,6.25}{
\draw [thick, dotted, ltcolorblue] (\x,-2.5) -- (\x,2.5);
}

\draw [ltcolorblue] (.725, 2.5) node {Input layer\vphantom{Àq}};
\draw [ltcolorblue] (4, 2.5) node {Hidden layers\vphantom{Àq}};
\draw [ltcolorblue] (7.5, 2.5) node {Output layer\vphantom{Àq}};

\draw [thick, ltcolorred, latex-latex] (1.75,-2.25) -- (6.25,-2.25);
\draw [ltcolorred] (4, -2.5) node {$N_L$\vphantom{Àq}};

\draw [thick, ltcolorred, latex-latex] (5,-2.125) -- (5,2.125);
\draw [ltcolorred] (5, 0) node [left] {$N_N$\vphantom{Àq}};
...
\submanip linear for input and output layers;
